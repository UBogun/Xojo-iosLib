...
#tag WindowCode
	...
	#tag Event
		Sub ToolbarPressed(button As iOSToolButton)
		  dim help as new InfoView ("Here you can see the speed difference between a series of 50 iOSGraphics.DrawRect calls against one DrawRects call by iOSGraphicsExtension." + eol + _
...
#tag Events Canvas1
	#tag Event
		Sub Paint(g As iOSGraphics)
		  ...
		  dim myArray(49) AS FoundationFrameWork.NSRect
		  for q as integer = 0 to 49
		    myArray(q)=FoundationFrameWork.NSMakeRect(math.RandomInt(0,me.Width/2), math.RandomInt (0, me.Height/2), math.RandomInt(0,me.Width/2), math.RandomInt(0, me.Height/2))
		  next
