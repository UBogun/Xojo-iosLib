...
#tag Events Table1
	#tag Event
		Sub Open()
		  ...
		  me.AddRow 0, "AppleDynamics (UIDynamics)"
	...
	#tag Event
		Sub Action(section As Integer, row As Integer)
		  ...
		  case "AppleBezierPath"
		    v3 = new BezierPathView
		  case "AppleDynamics (UIDynamics)"
		    v3 = new UIdynamicsView
		  End Select
