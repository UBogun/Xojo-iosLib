	...
	#tag Event
		Sub ToolbarPressed(button As iOSToolButton)
		  ...
		  if button.Caption = "Animate" then
		    ...
		    dim help as new InfoView ("Block animations are property animations on some of the properties of a UIView, so you can animate about every visible object on the screen. You can even attach them to a iOSView's AppleView object like I did here with the backgroundcolor property." + eol + _
