...
Inherits AppleObject
	...
	#tag Method, Flags = &h0
		Function Compare(IndexPath as AppleIndexPath) As NSComparisonResult
		  return Compare (id, IndexPath.id)
		End Function
	#tag EndMethod

	#tag ExternalMethod, Flags = &h21
		Attributes( hidden ) Private Declare Function compare Lib FoundationLibname Selector "compare:" (id as ptr, otherPath as ptr) As NSComparisonResult
