...
Inherits AppleCALayer
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if Target64bit
			    Declare Function emitterDepth lib QuartzCoreLib selector "emitterDepth" (id as ptr) as double
			  #elseif Target32Bit
			    Declare Function emitterDepth lib QuartzCoreLib selector "emitterDepth" (id as ptr) as single
			  #endif
		...
		#tag Setter
			Set
			  #if Target64bit
			    Declare Sub setEmitterDepth lib QuartzCoreLib selector "setEmitterDepth:" (id as ptr, value as double)
			  #elseif Target32Bit
			    Declare Sub setEmitterDepth lib QuartzCoreLib selector "setEmitterDepth:" (id as ptr, value as single)
			  #endif
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if Target64bit
			    Declare Function emitterZPosition lib QuartzCoreLib selector "emitterZPosition" (id as ptr) as double
			  #elseif Target32Bit
			    Declare Function emitterZPosition lib QuartzCoreLib selector "emitterZPosition" (id as ptr) as single
			  #endif
		...
		#tag Setter
			Set
			  #if Target64bit
			    Declare Sub setEmitterZPosition lib QuartzCoreLib selector "setEmitterZPosition:" (id as ptr, value as double)
			  #elseif Target32Bit
			    Declare Sub setEmitterZPosition lib QuartzCoreLib selector "setEmitterZPosition:" (id as ptr, value as single)
			  #endif
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  declare function emitterMode lib QuartzCoreLib selector "emitterMode" (id as ptr) as CFStringRef
			  return emitterMode (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare Sub setEmitterMode lib QuartzCoreLib selector "setEmitterMode:" (id as ptr, value as CFStringRef)
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  declare function emitterShape lib QuartzCoreLib selector "emitterShape" (id as ptr) as CFStringRef
			  return emitterShape (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare Sub setEmitterShape lib QuartzCoreLib selector "setEmitterShape:" (id as ptr, value as CFStringRef)
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  declare function renderMode lib QuartzCoreLib selector "renderMode" (id as ptr) as CFStringRef
			  return renderMode (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare Sub setRenderMode lib QuartzCoreLib selector "setRenderMode:" (id as ptr, value as CFStringRef)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function preservesDepth lib QuartzCoreLib selector "preservesDepth" (id as ptr) as Boolean
			  Return preservesDepth (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  Declare Sub setPreservesDepth lib QuartzCoreLib selector "setPreservesDepth:" (id as ptr, value as Boolean)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function seed lib QuartzCoreLib selector "seed" (id as ptr) as uint32
			  Return  seed (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  Declare Sub setSeed lib QuartzCoreLib selector "setSeed:" (id as ptr, value as uint32)
			  setSeed id, value
			End Set
		#tag EndSetter
		Seed As UInt32
