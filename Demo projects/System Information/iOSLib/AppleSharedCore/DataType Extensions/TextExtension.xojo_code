...
Protected Module TextExtension
	...
	#tag Method, Flags = &h0
		Function toAppleData(extends t as text, encoding as AppleString.StringEncodings = AppleString.StringEncodings.utf8) As AppleData
		  return t.toapplestring.toAppleData (encoding)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h0
		Function toAppleString(extends t as text) As AppleString
		  return new AppleString(t)
		End Function
	#tag EndMethod
