...
Inherits AppleObject
	...
	#tag Method, Flags = &h0
		Sub Constructor(Format as AVAudioCommonFormat, SampleRate as Double, Layout as AudioChannelLayout, Interleaved as Boolean)
		  // Calling the overridden superclass constructor.
		  // Note that this may need modifications if there are multiple constructor choices.
		  // Possible constructor calls:
		  // Constructor() -- From AppleObject
	...
	#tag Method, Flags = &h0
		Sub Constructor(Format as AVAudioCommonFormat, SampleRate as Double, Channels as UInt32, Interleaved as Boolean)
	...
	#tag ExternalMethod, Flags = &h21
		Private Declare Function initCommonFormat Lib AVFoundationLibname Selector "initWithCommonFormat:sampleRate:channels:interleaved:" (id as ptr, Format as AVAudioCommonFormat, SampleRate as Double, Channels as UInt32, Interleave as Boolean) As Ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21
		Private Declare Function initCommonFormatLayout Lib AVFoundationLibname Selector "initWithCommonFormat:sampleRate:interleaved:channelLayout:" (id as ptr, Format as AVAudioCommonFormat, SampleRate as Double, Interleave as Boolean, LAyout as AudioChannelLayout) As Ptr
	#tag EndExternalMethod
