...
Inherits AppleControl
	...
	#tag Method, Flags = &h0, Description = 52657475726E732074686520617070656172616E63652070726F787920666F7220746865207265636569766572207468617420686173207468652070617373656420747261697420636F6C6C656374696F6E2E
		 Shared Function Appearance(Collection as AppleTraitCollection) As appletextfield
		  return appletextfield.MakeFromPtr (getappearanceForTrait(classptr, collection))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0, Description = 52657475726E732074686520636F6E74726F6CE280997320626F726465722072656374616E676C652E
		Function BorderRectForBounds(Bounds as FoundationFramework.NSRect) As FoundationFramework.NSRect
		  ...
		  #elseif Target32Bit
		    Declare Function borderRectForBounds lib UIKitLibname selector "borderRectForBounds:" (id as ptr, bounds  as FoundationFramework.NSRect) as FoundationFramework.NSRect32Bit
		    return  borderRectForBounds (id, bounds).toNSRect
		  #endif
	...
	#tag Method, Flags = &h0, Description = 447261777320746865206669656C642773207465787420696E20746865207370656369666965642072656374616E676C6520286966206120636F6E746578742065786973747329
		Sub DrawText(rect as FoundationFrameWork.nsrect)
		  ...
		  #elseif Target32Bit
		    DrawTextinRect32 (id, rect.tonsrect32)
		  #endif
		End Sub
	#tag EndMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Attributes( hidden ) Private Declare Sub drawTextInRect32 Lib uikitlibname Selector "drawTextInRect:" (id as ptr, rect as FoundationFrameWork . nsrect32Bit)
	#tag EndExternalMethod
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  return new AppleTextfield(GetAppearance(FoundationFrameWork.NSClassFromString("UITextField")))
			End Get
		#tag EndGetter
