...
Inherits AppleView
	...
	#tag ExternalMethod, Flags = &h0
		Attributes( hidden ) Declare Function gettextRectForBounds32 Lib uikitlibname Selector "textRectForBounds:limitedToNumberOfLines:" (id as ptr, bounds as foundationframework . nsrect32Bit, Lines as Integer) As FoundationFrameWork.nsrect32Bit
	#tag EndExternalMethod
	...
	#tag Method, Flags = &h0, Description = 52657475726E732074686520636F6D70757465642064726177696E672072656374616E676C6520666F7220746865206C6162656CE280997320746578742E
		Function TextRectForBounds(bounds as FoundationFrameWork.nsrect, lines as integer) As FoundationFrameWork.nsrect
		  ...
		  #elseif Target32Bit
		    return gettextRectForBounds32(id, bounds.tonsrect32, lines).toNSRect
		  #endif
		End Function
	#tag EndMethod
	...
	#tag ComputedProperty, Flags = &h0, Description = 5768657468657220746865206C6162656C207469676874656E732074657874206265666F7265207472756E636174696E672E20417661696C61626C652073696E636520694F5320392E302E
		#tag Getter
			Get
			  if me.RespondsToSelector(classptr, "allowsDefaultTighteningForTruncation") then
			    Return getallowsDefaultTighteningForTruncation(id)
			  end if
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  if me.RespondsToSelector(classptr, "setAllowsDefaultTighteningForTruncation:") then
			    setallowsDefaultTighteningForTruncation id, value
			  end if
			End Set
		#tag EndSetter
