...
Inherits AppleSKTexture
	...
	#tag Method, Flags = &h21
		Private Sub ModificationBlockTemplate(pixelData as Ptr, LengthinBytes as Integer)
		  ...
		  dim PixelBlock as new MutableMemoryBlock (pixelData, LengthinBytes)
	...
	#tag Method, Flags = &h0
		Sub ModifyPixelData(ModificationBlock as AppleBlock)
		  Declare sub modifyPixelDataWithBlock lib SpriteKit selector "modifyPixelDataWithBlock:" (id as ptr, block as ptr)
