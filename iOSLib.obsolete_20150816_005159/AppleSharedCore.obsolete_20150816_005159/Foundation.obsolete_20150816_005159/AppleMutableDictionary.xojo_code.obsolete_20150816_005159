...
Inherits AppleDictionary
	#tag Method, Flags = &h0
		Sub AddDictionary(aDictionary as AppleDictionary)
		  declare sub addEntriesFromDictionary lib Foundation selector "addEntriesFromDictionary:" (id as ptr, aDictionary as ptr)
	...
	#tag Method, Flags = &h0
		Sub ObjectForKey(Key as cfstringref, assigns anObject as AppleGeneralObject)
		  Declare sub setObjectForKeyString lib Foundation selector "setObject:forKey:" (id as ptr, value  as ptr, key as cfstringref)
	...
	#tag Method, Flags = &h0
		Sub SetDictionary(aDictionary as AppleDictionary)
		  declare sub SetDictionary lib Foundation selector "setDictionary:" (id as ptr, aDictionary as ptr)
	...
	#tag Method, Flags = &h0
		Sub SetObjectForKey(Key as Ptr, anObject as Ptr)
		  Declare sub setObjectForKey lib Foundation selector "setObject:forKey:" (id as ptr, value  as ptr, key as ptr)
	...
	#tag Method, Flags = &h0
		Sub ValueForKey(Key as CFstringRef, assigns value as cfstringref)
		  Declare sub setValueForKey lib Foundation selector "setValue:forKey:" (id as ptr, value as CFStringRef, key as CFStringRef)
