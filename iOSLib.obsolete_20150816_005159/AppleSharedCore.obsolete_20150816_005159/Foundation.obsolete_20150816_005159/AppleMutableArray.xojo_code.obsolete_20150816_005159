...
Inherits AppleArray
	#tag Method, Flags = &h0
		Sub Addobject(anObject as AppleGeneralObject)
		  AddPtr anObject.GeneralID
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub AddPtr(anObject as Ptr)
		  Declare Sub addObject lib foundation selector "addObject:" (id as ptr, value as ptr)
	...
	#tag Method, Flags = &h0
		Sub AddText(aText as CFStringREf)
		  Declare Sub addObject lib foundation selector "addObject:" (id as ptr, value as cfstringref)
		  addObject (id, atext)
		End Sub
	#tag EndMethod
