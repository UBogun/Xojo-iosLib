...
Inherits AppleCAMediaTimingObject
	#tag Method, Flags = &h1000
		Sub Constructor()
		  declare function animation lib QuartzCore selector "animation" (id as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function ShouldArchiveValueForKey(Key As CFStringRef) As Boolean
		  ...
		  declare function shouldArchiveValueForKey lib QuartzCore selector "shouldArchiveValueForKey:" (id as ptr, key as CFStringRef) as Boolean
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function removedOnCompletion lib QuartzCore selector "isRemovedOnCompletion" (id as ptr) as Boolean
		...
		#tag Setter
			Set
			  declare Sub setremovedOnCompletion lib QuartzCore selector "setRemovedOnCompletion:" (id as ptr, value as Boolean)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare Function timingFunction lib QuartzCore selector "timingFunction" (id as ptr) as ptr
		...
		#tag Setter
			Set
			  declare sub setTimingFunction lib QuartzCore selector "setTimingFunction:" (id as ptr, value as ptr)
