...
Inherits AppleObject
	...
	#tag Method, Flags = &h0
		Function CGImage(ciimage as AppleCIImage, aRect as NSRect) As AppleCGImage
		  #if Target64Bit
		    declare function createCGImage lib QuartzCore selector "createCGImage:fromRect:" (id as ptr, ciimage as ptr, aRect as NSRect) as ptr
		    return new AppleCGImage (createCGImage (id, ciimage.Id, aRect))
		  #elseif Target32Bit
		    declare function createCGImage lib QuartzCore selector "createCGImage:fromRect:" (id as ptr, ciimage as ptr, aRect as NSRect32Bit) as ptr
	...
	#tag Method, Flags = &h1000
		Sub Constructor(useSoftwareRenderer As Boolean = False, lowPriority as boolean = false)
		  declare function contextWithOptions lib QuartzCore selector "contextWithOptions:" (id as ptr, options as ptr) as ptr
