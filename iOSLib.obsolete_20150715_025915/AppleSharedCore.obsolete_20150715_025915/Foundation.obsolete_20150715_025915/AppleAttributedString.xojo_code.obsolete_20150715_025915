...
Inherits AppleObject
	#tag Method, Flags = &h0
		Function AttributesAtIndex(index as UInteger) As AppleDictionary
		  declare function attributesAtIndex lib Foundation selector "attributesAtIndex:effectiveRange:" (id as ptr,  rangeptr as ptr) as Ptr
	...
	#tag Method, Flags = &h1000
		Sub Constructor(astring as AppleAttributedString)
		  declare function initWithAttributedString lib Foundation selector "initWithAttributedString:" (id as ptr, astring as Ptr) as ptr
	...
	#tag Method, Flags = &h1000
		Sub Constructor(astring as CFStringRef)
		  declare function initWithString lib Foundation selector "initWithString:" (id as ptr, astring as CFStringRef) as ptr
	...
	#tag Method, Flags = &h0
		Sub Draw(aPoint as NSPoint)
		  #if Target64Bit
		    declare Sub drawAtPoint lib Foundation selector "drawAtPoint:" (id as ptr, value as NSPoint)
		    drawAtPoint (id, aPoint)
		  #elseif Target32Bit
		    declare Sub drawAtPoint lib Foundation selector "drawAtPoint:" (id as ptr, value as NSPoint32Bit)
	...
	#tag Method, Flags = &h0
		Sub Draw(ARect as NSRect)
		  ...
		  #if Target64Bit
		    declare Sub drawInRect lib Foundation selector "drawInRect:" (id as ptr, value as NSRect)
		    drawInRect (id, aRect)
		  #elseif Target32Bit
		    declare Sub drawInRect lib Foundation selector "drawInRect:" (id as ptr, value as NSRect32Bit)
	...
	#tag Method, Flags = &h0
		Sub Draw(ARect as NSRect, options as AppleStringDrawingOptions, byref context as AppleStringDrawingContext)
		  #if Target64Bit
		    declare Sub drawWithRect lib Foundation selector "drawWithRect:options:context:" (id as ptr, value as NSRect, options as integer, context as ptr)
		    drawWithRect (id, aRect, options.id, context.id)
		  #elseif Target32Bit
		    declare Sub drawWithRect lib Foundation selector "drawWithRect:options:context:" (id as ptr, value as NSRect32Bit, options as integer, context as ptr)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function string_ lib Foundation selector "string" (id as ptr) as CFStringRef
			  return string_ (id)
			End Get
		#tag EndGetter
		toText As Text
