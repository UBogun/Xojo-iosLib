...
#tag Events Table1
	#tag Event
		Sub Open()
		  ...
		  me.AddRow 4, "AppleIntrospection"
		  me.AddSection "iosLibSpriteKit"
		  me.AddRow 5, "SpriteKit (optimized for iPad)"
		  me.AddSection "Xojo control extensions"
		  me.AddRow 6, "iOSButton"
		  me.AddRow 6, "iOSTextField"
		  me.AddRow 6, "iOSGraphics"
		  me.AddSection "Fonts"
	...
	#tag Event
		Sub Action(section As Integer, row As Integer)
		  ...
		  case "AppleIntrospection"
		    v3 = new IntrospectionView
		  case "AppleCIFilter"
		    v3 = new CiFilterView
		  case "SpriteKit (optimized for iPad)"
		    v3 = new SpriteKitView
		  case "iOSButton"
		    v3 = new ButtonView
		  case "iOSTextField"
