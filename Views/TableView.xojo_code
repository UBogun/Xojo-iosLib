...
#tag Events TextArea1
	#tag Event
		Sub Open()
		  ...
		  me.CellBackgroundColor(1,0) = &c000000ff
		  ...
		  iOSControlExtension.setFrame myeffect.Handle, iOSControlExtension.getFrame (me.Cell(0,0))
		  me.ViewHandle = myeffect.Handle
		  me.CellBackgroundView (1,0)=myeffect.Handle
		  me.SeparatorEffect (UIVisualEffectView.EffectType.vibrancy, UIVisualEffectView.BlurEffectStyle.dark)
		  UpdateValues
