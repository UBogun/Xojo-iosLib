...
Inherits iOSLibResponder
	#tag Method, Flags = &h0
		Function ActionForKey(Key as CFStringRef) As iOSLibSKAction
		  Declare Function actionForKey lib SpriteKit selector "actionForKey:" (id as ptr, key as CFStringRef) as Ptr
		  return iOSLibSKAction.MakeFromPtr (actionForKey (id, key))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function ChildNode(Name as text) As iOSLibSKNode
		  ...
		  return iOSLibSKNode.MakeFromPtr ( result)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h0
		Function ChildNodes(Name as CFStringRef) As iOSLibArray
		  ...
		  return iOSLibArray.MakeFromPtr ( objectForKeyedSubscript (id, name))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function ConvertPointFromNode(aPoint as NSPoint, aNode as iOSLibSKNode) As NSPoint
		  #if Target64Bit
	...
	#tag Method, Flags = &h0
		Function ConvertPointToNode(aPoint as NSPoint, aNode as iOSLibSKNode) As NSPoint
		  #if Target64Bit
	...
	#tag Method, Flags = &h1
		Protected Function getBlendColor() As iOSLibColor
		  Declare function BlendColor lib SpriteKit selector "color" (id as ptr) as Ptr
		  return new iOSLibColor (BlendColor (id))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function InParentHierarchy(Parent as iOSLibSKNode) As Boolean
	...
	#tag Method, Flags = &h0
		Sub InsertChild(Child as ioslibsknode, Index as Integer)
	...
	#tag Method, Flags = &h0
		Function IntersectsNode(aNode as iOSLibSKNode) As Boolean
	...
	#tag Method, Flags = &h0
		 Shared Function MakeFromPtr(aPtr as Ptr) As iosLibSKNode
		  if aptr <> nil then
		    dim result as new iOSLibSKNode(aptr)
		    return result
		  end if
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub RemoveChildrenInArray(anArray as iOSLibArray)
	...
	#tag Method, Flags = &h0
		Sub RunActionWithCompletionBlock(Action as iOSLibSKAction, block as iOSBlock)
	...
	#tag Method, Flags = &h0
		Sub RunActionWithEvent(Action as iOSLibSKAction)
		  Declare sub runActionCompletion lib SpriteKit selector "runAction:completion:" (id as ptr, action as ptr, completion as ptr)
	...
	#tag Method, Flags = &h0
		Sub RunActionWithKey(Action as iOSLibSKAction, key as CFStringRef)
	...
	#tag Method, Flags = &h0
		Sub RunBlockOnChildren(ChildName as CFStringRef, Block as iOSBlock)
	...
	#tag Method, Flags = &h21
		Private Sub RunBlockonChildrenTemplate(Child as ptr, byref stop as boolean)
		  dim currentnode as new iOSLibSKNode(child)
	...
	#tag Method, Flags = &h1
		Protected Sub setBlendColor(value as iOSLibColor)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return iOSLibArray.MakeFromPtr (children(id))
			End Get
		#tag EndGetter
		Children As iOSLibArray
	#tag EndComputedProperty
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return iOSLibSKNode.MakeFromPtr (parent(id))
			End Get
		#tag EndGetter
		Parent As ioslibsknode
	#tag EndComputedProperty
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return iOSLibSKPhysicsBody.MakeFromPtr (physicsBody(id))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			...
			End Set
		#tag EndSetter
		PhysicsBody As iOSLibSKPhysicsBody
	#tag EndComputedProperty
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return iOSLibSKScene.MakeFromPtr (scene(id))
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return iOSLibMutableDictionary.MakeFromPtr (userData(id))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			...
			End Set
		#tag EndSetter
		UserData As iOSLibMutableDictionary
	#tag EndComputedProperty
