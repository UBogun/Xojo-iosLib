...
Inherits iOSLibView
	...
	#tag Method, Flags = &h0
		Function ConvertPointFromScene(aPoint as NSPoint, asCene as iOSLibSKScene) As NSPoint
		  #if Target64Bit
	...
	#tag Method, Flags = &h0
		Function ConvertPointToScene(aPoint as NSPoint, aScene as iOSLibSKScene) As NSPoint
		  #if Target64Bit
	...
	#tag Method, Flags = &h0
		Sub PresentScene(aScene as iOSLibSKScene)
	...
	#tag Method, Flags = &h0
		 Shared Function SpriteKitEnabled() As Boolean
		  ...
		  if not isenabled then
		    ...
		    if result = nil then
		      call iOSLibSystem.LoadFramework ("SpriteKit") // If something goes wrong, we have an expection here.
		    end if
		    isenabled = true
		  end if
		  return isenabled
