#tag Class
Protected Class iOSLibSKSpriteNode
Inherits iOSLibSKNode
	...
	#tag Method, Flags = &h1000
		Sub Constructor(acolor as ioslibcolor, aSize as nssize)
		  #if Target64Bit
	...
	#tag Method, Flags = &h1000
		Sub Constructor(texture as iOSLibSKTexture, aColor as iOSLibColor, size as NSSize)
		  #if Target64Bit
	...
	#tag Method, Flags = &h1000
		Sub Constructor(texture as iOSLibSKTexture, NormalMap as iOSLibSKTexture)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return iOSLibSKTexture.MakefromPtr (normalTexture(id))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			...
			End Set
		#tag EndSetter
		NormalTexture As iOSLibSKTexture
	#tag EndComputedProperty
