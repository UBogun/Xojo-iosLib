...
Inherits iOSLibObject
	...
	#tag Method, Flags = &h1000
		Sub Constructor(c1x as single, c1y as single, c2x as single, c2y as single)
		  declare function initWithControlPoints lib UIKit selector "initWithControlPoints::::" (id as ptr, c1x as single, c1y as single, c2x as single, c2y as single) as ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  static mDefault as iOSLibCAMediaTimingFunction = new iOSLibCAMediaTimingFunction (iOSLibCAMediaTimingFunction.TimingFunction.default)
			  return mDefault
			End Get
		#tag EndGetter
		Shared DefaultFunction As iOSLibCAMediaTimingFunction
	#tag EndComputedProperty

	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  static mEaseInout as iOSLibCAMediaTimingFunction = new iOSLibCAMediaTimingFunction (iOSLibCAMediaTimingFunction.TimingFunction.EaseInEaseOut)
			  return mEaseInout
			End Get
		#tag EndGetter
		Shared EaseInEaseOutFunction As iOSLibCAMediaTimingFunction
	#tag EndComputedProperty

	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  static mEaseIn as iOSLibCAMediaTimingFunction = new iOSLibCAMediaTimingFunction (iOSLibCAMediaTimingFunction.TimingFunction.EaseIn)
			  return mEaseIn
			End Get
		#tag EndGetter
		Shared EaseInFunction As iOSLibCAMediaTimingFunction
	#tag EndComputedProperty

	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  static mEaseOut as iOSLibCAMediaTimingFunction = new iOSLibCAMediaTimingFunction (iOSLibCAMediaTimingFunction.TimingFunction.easeout)
			  return mEaseOut
			End Get
		#tag EndGetter
		Shared EaseOutFunction As iOSLibCAMediaTimingFunction
	#tag EndComputedProperty

	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  static mLinear as iOSLibCAMediaTimingFunction = new iOSLibCAMediaTimingFunction (iOSLibCAMediaTimingFunction.TimingFunction.Linear)
			  return mLinear
			End Get
		#tag EndGetter
		Shared LinearFunction As iOSLibCAMediaTimingFunction
	#tag EndComputedProperty
