...
Inherits AppleObject
	...
	#tag Method, Flags = &h1000
		Sub Constructor(Identity as AppleSecurityIdentity, Ceritificates as AppleArray, Persistence as NSURLCredentialPersistence)
		  ...
		  Super.Constructor (initWithIdentity(alloc(ClassPtr), Identity.CFTypeRef, Certificates.id, Persistence))
		  MHasOwnership = true
	...
	#tag Method, Flags = &h1000
		Sub Constructor(Trust as AppleSecurityTrust)
		  ...
		  // Constructor() -- From AppleObject
		  // Constructor(AnId as Ptr) -- From AppleObject
		  Super.Constructor (initWithTrust(alloc(ClassPtr), Trust.CFTypeRef))
		  mHasOwnership = true
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return AppleSecurityIdentity.makefromCFTypeRef (identity(id))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  Declare Sub setHTTPAdditionalHeaders lib FoundationLibName  selector "setHTTPAdditionalHeaders:" (id as ptr, value as ptr)
			  setHTTPAdditionalHeaders id, value.CFTypeRef
			End Set
		#tag EndSetter
		Identity As AppleSecurityIdentity
	#tag EndComputedProperty
