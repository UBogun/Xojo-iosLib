...
Inherits AppleCAPropertyAnimation
	...
	#tag Method, Flags = &h1000
		Sub Constructor(Key as Properties, myvalues as AppleArray)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  static mConstantDict as AppleMutableDictionary
			  if mConstantDict = nil then
			    mConstantDict = new AppleMutableDictionary (5)
			...
			End Get
		#tag EndGetter
		Shared CalculationValueConstants As AppleDictionary
	#tag EndComputedProperty
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function keyTimes lib QuartzCoreLib selector "keyTimes" (id as ptr) as Ptr
			  return AppleArray.MakeFromPtr (keyTimes (id))
			  
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare Sub setKeyTimes lib QuartzCoreLib selector "setKeyTimes:" (id as ptr, value as Ptr)
	...
	#tag ComputedProperty, Flags = &h21
		#tag Getter
			Get
			  Declare Function calculationMode lib QuartzCoreLib selector "calculationMode" (id as ptr) as CFStringRef
			  return calculationMode (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare sub setCalculationMode lib QuartzCoreLib selector "setCalculationMode:" (id as ptr, value as CFStringRef)
	...
	#tag ComputedProperty, Flags = &h21
		#tag Getter
			Get
			  Declare Function rotationMode lib QuartzCoreLib selector "rotationMode" (id as ptr) as CFStringRef
			  return rotationMode (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare sub setRotationMode lib QuartzCoreLib selector "setRotationMode:" (id as ptr, value as CFStringRef)
			  Declare sub setRotationModePtr lib QuartzCoreLib selector "setRotationMode:" (id as ptr, value as ptr)
			  if value.Empty then
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function path lib QuartzCoreLib selector "path" (id as ptr) as Ptr
		...
		#tag Setter
			Set
			  declare Sub setPath lib QuartzCoreLib selector "setPath:" (id as ptr, value as Ptr)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function timingFunctions lib QuartzCoreLib selector "timingFunctions" (id as ptr) as Ptr
			  return AppleArray.MakeFromPtr (timingFunctions (id))
			  
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare Sub setTimingFunctions lib QuartzCoreLib selector "setTimingFunctions:" (id as ptr, value as Ptr)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function values lib QuartzCoreLib selector "values" (id as ptr) as Ptr
			  return AppleArray.MakeFromPtr (values (id))
			  
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare Sub setValues lib QuartzCoreLib selector "setValues:" (id as ptr, value as Ptr)
