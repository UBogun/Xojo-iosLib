...
Inherits AppleCALayer
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function scrollMode lib QuartzCoreLib selector "scrollMode" (id as ptr) as CFStringRef
		...
		#tag Setter
			Set
			  Declare sub setScrollMode lib QuartzCoreLib selector "setScrollMode:" (id as ptr, value as CFStringRef)
			  dim mode as text
			  select case value
