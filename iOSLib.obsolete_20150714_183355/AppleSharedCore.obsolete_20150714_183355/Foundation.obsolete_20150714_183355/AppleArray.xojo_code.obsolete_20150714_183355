...
Inherits AppleMutableObjectInterface
	...
	#tag Method, Flags = &h0
		Function PtrAtIndex(Index as Uinteger) As Ptr
		  declare function objectAtIndex lib foundation selector "objectAtIndex:" (id as ptr, index as uinteger) as Ptr
	...
	#tag Method, Flags = &h0
		Function TextAtIndex(Index as Uinteger) As cfstringref
		  declare function objectAtIndex lib foundation selector "objectAtIndex:" (id as ptr, index as uinteger) as CFStringRef
		  return objectAtIndex (id, index)
