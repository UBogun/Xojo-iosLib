...
Inherits AppleObject
	...
	#tag Method, Flags = &h1000
		Sub Constructor(AnArray as AppleArray)
		  Declare Function initWithArray lib Foundation selector "initWithArray:" (id as ptr, anArray as Ptr) as Ptr
	...
	#tag Method, Flags = &h1000
		Sub Constructor(Paramarray Objects() as AppleObject)
		  Declare Function initWithObjects lib Foundation selector "initWithObjects:" (id as ptr, anArray as Ptr) as Ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function allObjects lib Foundation selector "allObjects" (id as ptr) as Ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function anyObject lib Foundation selector "anyObject" (id as ptr) as Ptr
