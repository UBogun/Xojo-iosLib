#tag Class
Protected Class AppleColorPicker
	#tag Method, Flags = &h0
	...
	#tag Method, Flags = &h0
		Function GetColor(currentView as iosview, byref Cancelled as Boolean) As Color
		  ...
		  cp.AppleViewCTRL.ModalPresentationStyle = AppleViewController.UIViewModalPresentationStyle.FormSheet
		  currentview.AppleViewCTRL.Present cp.AppleViewCTRL, true
		  while not Returned
