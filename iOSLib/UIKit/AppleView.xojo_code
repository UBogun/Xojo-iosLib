...
Implements AppleEventForwarder
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_DidAddSubview(pid as ptr, sel as ptr, view as Ptr)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_DidMoveToSuperview(pid as ptr, sel as ptr)
		  dim ego as new AppleView (pid)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_DidMoveToWindow(pid as ptr, sel as ptr)
		  dim ego as new AppleView (pid)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_DrawRect32(pid as ptr, sel as ptr, rect as NSRect32Bit)
		  dim ego as new AppleView (pid)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_DrawRect64(pid as ptr, sel as ptr, rect as NSRect)
		  dim ego as new AppleView (pid)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_LayoutSubviews(pid as ptr, sel as ptr)
		  dim ego as new AppleView (pid)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_MotionBeganWithEvent(pid as ptr, sel as ptr, Type as AppleEvent.UIEventSubtype, anEvent as Ptr)
		  dim ego as new AppleView (pid)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_TouchesBeganWithEvent(pid as ptr, sel as ptr, Touchset as ptr, anEvent as Ptr)
		  dim ego as new AppleView (pid)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_TouchesCancelledWithEvent(pid as ptr, sel as ptr, Touchset as ptr, anEvent as Ptr)
		  dim ego as new AppleView (pid)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_TouchesEndedWithEvent(pid as ptr, sel as ptr, Touchset as ptr, anEvent as Ptr)
		  dim ego as new AppleView (pid)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_TouchesMovedWithEvent(pid as ptr, sel as ptr, Touchset as ptr, anEvent as Ptr)
		  dim ego as new AppleView (pid)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_willMoveToSuperview(pid as ptr, sel as ptr, view as Ptr)
		  dim ego as new AppleView (pid)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_willMoveToWindow(pid as ptr, sel as ptr, window as Ptr)
		  dim ego as new AppleView (pid)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub impl_willRemoveSubview(pid as ptr, sel as ptr, view as Ptr)
		  dim ego as new AppleView (pid)
