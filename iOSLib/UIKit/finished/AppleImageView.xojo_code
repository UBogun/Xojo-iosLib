...
Inherits AppleView
	...
	#tag Method, Flags = &h0, Description = 52657475726E732074686520617070656172616E63652070726F787920666F7220746865207265636569766572207468617420686173207468652070617373656420747261697420636F6C6C656374696F6E2E
		 Shared Function Appearance(Collection as AppleTraitCollection) As AppleImageView
		  return appleimageview.MakeFromPtr (getappearanceForTrait(classptr, collection))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h1000, Description = 52657475726E7320616E20696D616765207669657720696E697469616C697A65642077697468207468652073706563696669656420726567756C617220616E6420686967686C69676874656420696D616765732E
		Sub Constructor(animage as appleimage, highlightedImage as AppleImage)
		  Declare Function initWithImagehighlightedImage lib UIKitLibname selector "initWithImage:highlightedImage:" (id as ptr, animage as ptr, hightlightedimage as ptr) as ptr
		  // Calling the overridden superclass constructor.
		  // Note that this may need modifications if there are multiple constructor choices.
		  // Possible constructor calls:
		  // Constructor() -- From AppleView
		  ...
		  // Constructor() -- From AppleObject
		  // Constructor(AnId as Ptr) -- From AppleObject
		  Super.Constructor (initWithImagehighlightedImage(alloc(classptr), animage.id, highlightedimage.id))
		  MHasOwnership = true
	...
	#tag Method, Flags = &h0
		Sub Constructor(aFrame as FoundationFrameWork.nsrect)
		  ...
		  // Constructor() -- From AppleObject
		  // Constructor(AnId as Ptr) -- From AppleObject
		  Super.Constructor (doinitwithframe(classptr, aframe))
		  MHasOwnership = true
	...
	#tag Method, Flags = &h0, Description = 496E7465726E616C3A2054686520694F5375736572636F6E74726F6C20737562636C61737320696620636F6E7461696E656420696E20737563682E
		Attributes( hidden )  Function ParentControl() As iOSLibCanvas
		  ...
		  return if (wr = nil, nil,  iOSLIbImageView(wr.Value))
	...
	#tag Method, Flags = &h0, Description = 496E7465726E616C20666F72207265676973746572696E6720746865206D616E746C6520694F5355736572436F6E74726F6C2E
		Attributes( hidden )  Sub RegisterControl(ParentControl as iOSLibimageview)
	...
	#tag ComputedProperty, Flags = &h0, Description = 54686520617070656172616E6365206F626A65637420776869636820796F752063616E206D6F6469667920746F20696E666C75656E636520746865206C6F6F6B73206F66206576657279207669657720696E20796F75722070726F6A6563742E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  return appleimageview.MakeFromPtr(getappearance (classptr))
