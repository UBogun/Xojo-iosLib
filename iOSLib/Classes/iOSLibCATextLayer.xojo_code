#tag Class
Protected Class iOSLibCATextLayer
Inherits iOSLibCALayer
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare function wrapped lib uikit selector "isWrapped" (id as ptr) as Boolean
			  return wrapped (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  Declare Sub setWrapped lib UIKit selector "setWrapped:" (id as ptr, value as Boolean)
			  setWrapped (id, value)
			End Set
		#tag EndSetter
		Wrapped As Boolean
