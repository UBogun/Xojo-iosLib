...
Inherits ioslibcfobject
	#tag Method, Flags = &h21
		Private Function CGColorCreateCopyWithAlpha(acolor as ptr, alpha as double) As Ptr
		  #if target32bit
		    declare function CGColorCreateCopyWithAlpha lib CoreGraphics  (acolor as ptr, alpha as single) as Ptr
		  #elseif target64bit
		    declare function CGColorCreateCopyWithAlpha lib CoreGraphics  (acolor as ptr, alpha as double) as Ptr
		  #endif
	...
	#tag Method, Flags = &h21
		Private Function CGColorCreateGenericCMYK(cyan as double, magenta as double, yellow as double, black as double, alpha as double) As Ptr
		  #if target32bit
		    declare function CGColorCreateGenericCMYK lib CoreGraphics  (cyan as single, magenta as single, yellow as Single, black as single, alpha as single) as Ptr
		  #elseif target64bit
		    declare function CGColorCreateGenericCMYK lib CoreGraphics  (cyan as double, magenta as double, yellow as double, black as double, alpha as double) as Ptr
		  #endif
	...
	#tag Method, Flags = &h21
		Private Function CGColorCreateGenericGray(gray as double, alpha as double) As Ptr
		  #if target32bit
		    declare function CGColorCreateGenericGray lib CoreGraphics  (gray as Single, alpha as single) as Ptr
		  #elseif target64bit
		    declare function CGColorCreateGenericGray lib CoreGraphics  (gray as double, alpha as double) as Ptr
		  #endif
	...
	#tag Method, Flags = &h21
		Private Function CGColorCreateGenericRGB(red as double, green as double, blue as double, alpha as double) As Ptr
		  #if target32bit
		    declare function CGColorCreateGenericRGB lib CoreGraphics  (red as single, green as single, blue as Single, alpha as single) as Ptr
		  #elseif target64bit
		    declare function CGColorCreateGenericRGB lib CoreGraphics  (red as double, green as double, blue as double, alpha as double) as Ptr
		  #endif
	...
	#tag ExternalMethod, Flags = &h21
		Private Declare Function CGColorEqualToColor Lib coreGraphics (id as ptr, anotherid as ptr) As boolean
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21
		Private Declare Function CGColorGetColorSpace Lib coreGraphics (id as ptr) As Ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21
		Private Declare Function CGColorGetComponents Lib coreGraphics (id as ptr) As Ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21
		Private Declare Function CGColorGetConstantColor Lib coreGraphics (colorname as CFStringRef) As Ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21
		Private Declare Function CGColorGetNumberOfComponents Lib coreGraphics (id as ptr) As UInteger
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21
		Private Declare Function CGColorGetTypeID Lib coreGraphics (id as ptr) As UInteger
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21
		Private Declare Sub CGColorRelease Lib coreGraphics (id as ptr)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21
		Private Declare Function CGColorRetain Lib coreGraphics (id as ptr) As ptr
	#tag EndExternalMethod

	#tag Method, Flags = &h0
		Function ChangeAlpha(Alpha as Double) As iOSLibCGColor
		  return new iOSLibCGColor (CGColorCreateCopyWithAlpha (mCFTypeRef, Alpha))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Sub Destructor()
		  if hasOwnership then CGColorRelease (mCFTypeRef)
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Function Equals(anothercolor as iosLibCGColor) As boolean
		  Return CGColorEqualToColor (mCFTypeRef, anothercolor.mCFTypeRef)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h0
		 Shared Function fromColor(aColor as Color) As iosLibCGColor
		  return new iosLibCGColor (acolor)
		End Function
	#tag EndMethod
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if target32bit
			    declare function CGColorGetAlpha lib CoreGraphics  (id as ptr) as single
			  #elseif target64bit
			    declare function CGColorGetAlpha lib CoreGraphics  (id as ptr) as double
			  #endif
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  return iOSLibCFObject.CFCopyTypeIDDescription (TypeID)
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  return new iOSLibCGColorSpace (CGColorGetColorSpace (mcfTypeRef))
			End Get
		#tag EndGetter
		ColorSpace As iOSLibCGColorSpace
	#tag EndComputedProperty
