...
Inherits AppleCGPath
	...
	#tag Method, Flags = &h0
		Sub AddArcToPoint(x1 as double, y1 as double, x2 as double, y2 as double, radius as double)
		  AddArcToPoint x1, y1, x2, y2, radius, CGAffineTransformIdentity
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub AddCurvetoPoint(cp1x as double, cp1y as double, cp2x as double, cp2y as double, x as double, y as double)
		  AddCurvetoPoint cp1x, cp1y, cp2x, cp2y, x, y, CGAffineTransformIdentity
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub AddEllipse(aRect as NSRect)
		  AddEllipse arect, CGAffineTransformIdentity
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub AddEllipse(aRect as NSRect, aTransform as CGAffineTransform)
	...
	#tag Method, Flags = &h0
		Sub AddLines(Points As AppleArray, Count As UInteger = 0)
		  AddLines  Points, count, CGAffineTransformIdentity
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub AddLineToPoint(x as double, y as double)
		  AddLineToPoint  x, y, CGAffineTransformIdentity
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub AddPath(aPath as AppleCGPath)
		  AddPath apath, CGAffineTransformIdentity
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub AddQuadCurvetoPoint(cpx as double, cpy as double, x as double, y as double)
		  AddQuadCurveToPoint  cpx, cpy,  x, y, CGAffineTransformIdentity
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub AddRect(aRect as NSRect)
		  addrect arect, CGAffineTransformIdentity
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub AddRects(Rects As AppleArray, Count As UInteger = 0)
		  AddRects  Rects, count, CGAffineTransformIdentity
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub AddRelativeArc(x as double, y as double, radius as double, startAngle as Double, Delta as Double)
		  AddRelativeArc  x, y, radius, startAngle, delta,  CGAffineTransformIdentity
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub AddRoundedRect(aRect as NSRect, CornerWidth as Double, CornerHeight as Double)
		  AddRoundedRect arect, CornerWidth, CornerHeight, CGAffineTransformIdentity
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h1
		Protected Shared Sub CGPathAddEllipseInRect(APathRef as Ptr, aTransform as CGAffineTransform, aRect as NSRect)
		  #if Target64Bit
	...
	#tag Method, Flags = &h1
		Protected Shared Sub CGPathAddLines(APathRef as Ptr, aTransform as CGAffineTransform, PointArray as Ptr, Count As UInteger)
		  #if Target64Bit
		    Declare Sub CGPathAddLines lib CoreGraphics (id as ptr, aTransform as CGAffineTransform, Points as Ptr, Count As Uinteger)
		    CGPathAddLines (APathRef, aTransform, pointarray, count)
		  #elseif Target32Bit
		    Declare Sub CGPathAddLines lib CoreGraphics (id as ptr, aTransform as CGAffineTransform32Bit, Points as Ptr, Count As Uinteger)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub CGPathAddRect(APathRef as Ptr, aTransform as CGAffineTransform, aRect as NSRect)
		  #if Target64Bit
	...
	#tag Method, Flags = &h1
		Protected Shared Sub CGPathAddRects(APathRef as Ptr, aTransform as CGAffineTransform, RectArray as Ptr, Count As UInteger)
		  #if Target64Bit
		    Declare Sub CGPathAddRects lib CoreGraphics (id as ptr, aTransform as CGAffineTransform, Points as Ptr, Count As Uinteger)
		    CGPathAddRects (APathRef, aTransform, RectArray, count)
		  #elseif Target32Bit
		    Declare Sub CGPathAddRects lib CoreGraphics (id as ptr, aTransform as CGAffineTransform32Bit, Points as Ptr, Count As Uinteger)
	...
	#tag Method, Flags = &h1
		Protected Shared Sub CGPathAddRoundedRect(APathRef as Ptr, aTransform as CGAffineTransform, aRect as NSRect, cornerWidth as Double, CornerHeight as Double)
		  #if Target64Bit
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function CGPathCreateMutable Lib CoreGraphics () As Ptr
	#tag EndExternalMethod
	...
	#tag Method, Flags = &h0
		Sub MoveToPoint(x as double, y as double)
		  MoveToPoint  x, y, CGAffineTransformIdentity
		End Sub
	#tag EndMethod
