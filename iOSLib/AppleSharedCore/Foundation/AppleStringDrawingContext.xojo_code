...
Inherits AppleObject
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if Target64Bit
			    declare function actualScaleFactor lib Foundation selector "actualScaleFactor" (id as ptr) as double
			  #elseif Target32Bit
			    declare function actualScaleFactor lib Foundation selector "actualScaleFactor" (id as ptr) as single
			  #endif
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if Target64Bit
			    declare function totalBounds lib Foundation selector "totalBounds" (id as ptr) as nsrect
			    return totalBounds (id)
			  #elseif Target32Bit
			    declare function totalBounds lib Foundation selector "totalBounds" (id as ptr) as NSRect32Bit
