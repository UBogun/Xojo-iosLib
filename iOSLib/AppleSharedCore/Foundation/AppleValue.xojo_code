...
Inherits AppleObject
	...
	#tag Method, Flags = &h1000
		Sub Constructor(anObject as AppleObject, dontRetain as Boolean = false)
		  if dontRetain then
		    declare function valueWithNonretainedObject lib foundation selector "valueWithNonretainedObject:" (id as ptr, value as ptr) as ptr
	...
	#tag Method, Flags = &h1000
		Sub Constructor(T as CATransform3D)
		  #if target32bit
		    declare function valueWithCATransform3D lib foundation selector "valueWithCATransform3D:" (id as ptr, value as CATransform3D32Bit) as ptr
		    super.Constructor (valueWithCATransform3D (ClassPtr, T.toCATransform3D32Bit))
		  #elseif target64bit
		    declare function valueWithCATransform3D lib foundation selector "valueWithCATransform3D:" (id as ptr, value as CATransform3D) as ptr
	...
	#tag Method, Flags = &h1000
		Sub Constructor(APoint As NSPoint)
		  #if target32bit
		    declare function valueWithPoint lib foundation selector "valueWithPoint:" (id as ptr, value as NSPoint32Bit) as ptr
		    super.Constructor (valueWithPoint (ClassPtr, apoint.toNSPoint32))
		  #elseif target64bit
		    declare function valueWithPoint lib foundation selector "valueWithPoint:" (id as ptr, value as NSPoint) as ptr
	...
	#tag Method, Flags = &h1000
		Sub Constructor(ARect As NSRect)
		  #if target32bit
		    declare function valueWithRect lib foundation selector "valueWithRect:" (id as ptr, value as NSRect32Bit) as ptr
		    super.Constructor (valueWithRect (ClassPtr, aRect.toNSRect32))
		  #elseif target64bit
		    declare function valueWithRect lib foundation selector "valueWithRect:" (id as ptr, value as NSRect) as ptr
	...
	#tag Method, Flags = &h1000
		Sub Constructor(ASize As NSSize)
		  #if target32bit
		    declare function valueWithSize lib foundation selector "valueWithSize:" (id as ptr, value as NSSize32Bit) as ptr
		    super.Constructor (valueWithSize (ClassPtr, aSize.toNSSize32))
		  #elseif target64bit
		    declare function valueWithSize lib foundation selector "valueWithSize:" (id as ptr, value as NSSize) as ptr
	...
	#tag Method, Flags = &h0
		Sub Constructor(anid as ptr, CreateValue As Boolean = False)
		  if CreateValue then
		    declare function valueWithPointer lib foundation selector "valueWithPointer:" (id as ptr, value as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function Equals(anotherValue as AppleValue) As Boolean
		  declare function isEqualToValue lib Foundation selector "isEqualToValue:" (id as ptr, value as Ptr) as Boolean
	...
	#tag Method, Flags = &h1000
		Function ValueWithBytes(value as ptr, type as CString) As Ptr
		  declare function valueWithBytes lib foundation selector "valueWithBytes:objCType:" (id as ptr, value as ptr, type as CString) as ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if target32bit
			    declare function CATransform3DValue lib Foundation selector "CATransform3DValue" (id as ptr) as CATransform3D32Bit
			    return CATransform3DValue(id).toCATransform3D
			  #elseif target64bit
			    declare function CATransform3DValue lib Foundation selector "pointValue" (id as ptr) as CATransform3D
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function nonretainedObjectValue lib Foundation selector "nonretainedObjectValue" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if target32bit
			    declare function pointValue lib Foundation selector "pointValue" (id as ptr) as NSPoint32Bit
			    return pointValue (id).toNSPoint
			  #elseif target64bit
			    declare function pointValue lib Foundation selector "pointValue" (id as ptr) as NSPoint
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if target32bit
			    declare function rectValue lib Foundation selector "rectValue" (id as ptr) as NSRect32Bit
			    return rectValue (id).tonsrect
			  #elseif target64bit
			    declare function rectValue lib Foundation selector "rectValue" (id as ptr) as NSRect
			    return rectValue (id)
			  #endif
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if target32bit
			    declare function sizeValue lib Foundation selector "sizeValue" (id as ptr) as NSSize32Bit
			    return sizeValue (id).tonssize
			  #elseif target64bit
			    declare function sizeValue lib Foundation selector "sizeValue" (id as ptr) as nssize
			    return sizeValue (id)
			  #endif
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function pointerValue lib Foundation selector "pointerValue" (id as ptr) as ptr
