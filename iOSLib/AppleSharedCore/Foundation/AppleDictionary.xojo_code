...
Inherits AppleMutableObjectInterface
	#tag Method, Flags = &h0
		Function allKeysForObject(anObject as AppleGeneralObject) As AppleArray
		  declare Function allKeysForObject lib Foundation selector "allKeysForObject:" (id as ptr, anobject as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function PtrForKey(akey as Ptr) As Ptr
		  declare Function objectForKey lib Foundation selector "objectForKey:" (id as ptr, key as Ptr) as ptr
		  return objectForKey (id, akey)
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function TextForKey(akey as cfstringref) As Text
		  declare Function objectForKey lib Foundation selector "objectForKey:" (id as ptr, key as cfstringref) as cfstringref
		  return objectForKey (id, akey)
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function ValueForKey(Key as CFstringRef) As Ptr
		  declare function valueForKey lib Foundation selector "valueForKey:" (id as ptr, key as CFStringRef) as ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function allValues lib Foundation Selector "allValues"(id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare function descriptionInStringsFileFormat lib Foundation selector "descriptionInStringsFileFormat" (id as ptr) as CFStringRef
