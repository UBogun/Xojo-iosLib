#tag Class
Protected Class AppleURLAuthenticationChallenge1
Inherits AppleObject
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function failureResponse lib Foundation selector "failureResponse" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function previousFailureCount lib Foundation selector "previousFailureCount" (id as ptr) as Integer
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function proposedCredential lib Foundation selector "proposedCredential" (id as ptr) as Ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function protectionSpace lib Foundation selector "protectionSpace" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function sender lib Foundation selector "sender" (id as ptr) as ptr
