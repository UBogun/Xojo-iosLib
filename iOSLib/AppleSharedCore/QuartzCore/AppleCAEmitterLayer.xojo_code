#tag Class
Protected Class AppleCAEmitterLayer
Inherits AppleCALayer
	#tag Method, Flags = &h1000
		Sub Constructor()
		  Super.Constructor (Init(Alloc(ClassPtr)))
		  mHasOwnership = true
		  Seed = xojo.math.randomint (0, &hffffffff)
	...
	#tag ComputedProperty, Flags = &h21
		#tag Getter
			Get
			  static mConstantLib as AppleMutableDictionary
			  if mConstantLib = nil then
			    mConstantLib = new AppleMutableDictionary (15)
			...
			End Get
		#tag EndGetter
		Private Shared ConstantDict As AppleDictionary
	#tag EndComputedProperty
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if Target64bit
			    Declare Function emitterDepth lib QuartzCore selector "emitterDepth" (id as ptr) as double
			  #elseif Target32Bit
			    Declare Function emitterDepth lib QuartzCore selector "emitterDepth" (id as ptr) as single
			  #endif
		...
		#tag Setter
			Set
			  #if Target64bit
			    Declare Sub setEmitterDepth lib QuartzCore selector "setEmitterDepth:" (id as ptr, value as double)
			  #elseif Target32Bit
			    Declare Sub setEmitterDepth lib QuartzCore selector "setEmitterDepth:" (id as ptr, value as single)
			  #endif
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if Target64bit
			    Declare Function emitterSize lib QuartzCore selector "emitterSize" (id as ptr) as NSSize
			    return emitterSize (id)
			  #elseif Target32Bit
			    Declare Function emitterSize lib QuartzCore selector "emitterSize" (id as ptr) as NSSize32Bit
		...
		#tag Setter
			Set
			  #if Target64bit
			    Declare Sub setEmitterSize lib QuartzCore selector "setEmitterSize:" (id as ptr, value as nssize)
			    setEmitterSize id, value
			  #elseif Target32Bit
			    Declare Sub setEmitterSize lib QuartzCore selector "setEmitterSize:" (id as ptr, value as NSSize32Bit)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if Target64bit
			    Declare Function emitterZPosition lib QuartzCore selector "emitterZPosition" (id as ptr) as double
			  #elseif Target32Bit
			    Declare Function emitterZPosition lib QuartzCore selector "emitterZPosition" (id as ptr) as single
			  #endif
		...
		#tag Setter
			Set
			  #if Target64bit
			    Declare Sub setEmitterZPosition lib QuartzCore selector "setEmitterZPosition:" (id as ptr, value as double)
			  #elseif Target32Bit
			    Declare Sub setEmitterZPosition lib QuartzCore selector "setEmitterZPosition:" (id as ptr, value as single)
			  #endif
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  declare function emitterMode lib QuartzCore selector "emitterMode" (id as ptr) as CFStringRef
			  return emitterMode (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare Sub setEmitterMode lib QuartzCore selector "setEmitterMode:" (id as ptr, value as CFStringRef)
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  declare function emitterShape lib QuartzCore selector "emitterShape" (id as ptr) as CFStringRef
			  return emitterShape (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare Sub setEmitterShape lib QuartzCore selector "setEmitterShape:" (id as ptr, value as CFStringRef)
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  declare function renderMode lib QuartzCore selector "renderMode" (id as ptr) as CFStringRef
			  return renderMode (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare Sub setRenderMode lib QuartzCore selector "setRenderMode:" (id as ptr, value as CFStringRef)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function preservesDepth lib QuartzCore selector "preservesDepth" (id as ptr) as Boolean
			  Return preservesDepth (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  Declare Sub setPreservesDepth lib QuartzCore selector "setPreservesDepth:" (id as ptr, value as Boolean)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function seed lib QuartzCore selector "seed" (id as ptr) as uint32
			  Return  seed (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  Declare Sub setSeed lib QuartzCore selector "setSeed:" (id as ptr, value as uint32)
			  setSeed id, value
			End Set
		#tag EndSetter
		Seed As UInt32
