...
Inherits AppleResponder
	#tag Method, Flags = &h0
		 Shared Function DefaultValueForKey(Key As CFStringRef) As AppleObject
		  declare function defaultValueForKey lib QuartzCore selector "defaultValueForKey:" (id as ptr, key as CFStringRef) as Ptr
	...
	#tag Method, Flags = &h1
		Protected Function getFillMode(id as ptr) As CFStringRef
		  declare function fillMode lib QuartzCore selector "fillMode" (id as ptr) as CFStringRef
		  return fillMode (id)
	...
	#tag Method, Flags = &h1
		Protected Sub setFillMode(id as ptr, mode as CFstringRef)
		  declare sub setFillMode lib QuartzCore selector "setFillMode:" (id as ptr, value as CFStringRef)
		  setfillMode (id, mode)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function autoreverses lib QuartzCore selector "autoreverses" (id as ptr) as Boolean
		...
		#tag Setter
			Set
			  declare Sub setAutoreverses lib QuartzCore selector "setAutoreverses:" (id as ptr, value as Boolean)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function beginTime lib QuartzCore selector "beginTime" (id as ptr) as Double
			  return beginTime (id)
		...
		#tag Setter
			Set
			  declare Sub setBeginTime lib QuartzCore selector "setBeginTime:" (id as ptr, value as Double)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if target32bit
			    DEclare Function contentsRect lib QuartzCore selector "contentsRect" (id as ptr) as NSRect32Bit
			    return contentsRect(id).toNSRect
			  #elseif Target64Bit
			    DEclare Function contentsRect lib QuartzCore selector "contentsRect" (id as ptr) as NSRect
		...
		#tag Setter
			Set
			  #if target32bit
			    DEclare Sub setContentsRect lib QuartzCore selector "setContentsRect:" (id as ptr, value as NSRect32Bit)
			    setContentsRect id, value.toNSRect32
			  #elseif Target64Bit
			    DEclare Sub setContentsRect lib QuartzCore selector "setContentsRect:" (id as ptr, value as NSRect)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function duration lib QuartzCore selector "duration" (id as ptr) as Double
			  return duration (id)
		...
		#tag Setter
			Set
			  declare Sub setDuration lib QuartzCore selector "setDuration:" (id as ptr, value as Double)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function minificationFilterBias lib QuartzCore selector "minificationFilterBias" (id as ptr) as Single
		...
		#tag Setter
			Set
			  declare Sub setMinificationFilterBias lib QuartzCore selector "setMinificationFilterBias:" (id as ptr, value as Single)
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  declare function magnificationFilter lib QuartzCore selector "magnificationFilter" (id as ptr) as CFStringRef
			  return magnificationFilter (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare Sub setMagnificationFilter lib QuartzCore selector "setMagnificationFilter:" (id as ptr, value as CFStringRef)
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  declare function minificationFilter lib QuartzCore selector "minificationFilter" (id as ptr) as CFStringRef
			  return minificationFilter (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare Sub setMinificationFilter lib QuartzCore selector "setMinificationFilter:" (id as ptr, value as CFStringRef)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function repeatCount lib QuartzCore selector "repeatCount" (id as ptr) as Single
		...
		#tag Setter
			Set
			  declare Sub setRepeatCount lib QuartzCore selector "setRepeatCount:" (id as ptr, value as Single)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function repeatDuration lib QuartzCore selector "repeatDuration" (id as ptr) as Double
		...
		#tag Setter
			Set
			  declare Sub setRepeatDuration lib QuartzCore selector "setRepeatDuration:" (id as ptr, value as Double)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function speed lib QuartzCore selector "speed" (id as ptr) as Single
			  return speed (id)
		...
		#tag Setter
			Set
			  declare Sub setSpeed lib QuartzCore selector "setSpeed:" (id as ptr, value as Single)
			  setSpeed (id, value)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function style lib QuartzCore selector "style" (id as Ptr) as ptr
		...
		#tag Setter
			Set
			  declare Sub setStyle lib QuartzCore selector "setStyle:" (id as Ptr, value as ptr)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function timeOffset lib QuartzCore selector "timeOffset" (id as ptr) as Double
		...
		#tag Setter
			Set
			  declare Sub setTimeOffset lib QuartzCore selector "setTimeOffset:" (id as ptr, value as Double)
