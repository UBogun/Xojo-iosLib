...
Inherits AppleCALayer
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare function string_ lib QuartzCore selector "string" (id as ptr) as CFStringRef
			  return string_ (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  Declare Sub setString lib QuartzCore selector "setString:" (id as ptr, value as CFStringRef)
			  setString (id, value)
			End Set
		#tag EndSetter
		Content As Text
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare function wrapped lib QuartzCore selector "isWrapped" (id as ptr) as Boolean
			  return wrapped (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  Declare Sub setWrapped lib QuartzCore selector "setWrapped:" (id as ptr, value as Boolean)
			  setWrapped (id, value)
			End Set
		#tag EndSetter
		Wrapped As Boolean
