...
Inherits AppleAVAudioNode
	...
	#tag ExternalMethod, Flags = &h21
		Private Declare Function isPlaying Lib AVFoundationLibname Selector "isPlaying" (id as ptr) As Boolean
	...
	#tag Method, Flags = &h0
		Sub SchedulePlayback(AVFile as AppleAVAudioFile, atTime as AppleAVAudioTime, completionHandler as iosBlock = nil)
		  scheduleFileAtTime (id, avfile.id, atTime.id, if (completionHandler = nil, nil, completionHandler.Handle))
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub SchedulePlayback(Buffer as AppleAVAudioPCMBuffer, atTime as AppleAVAudioTime, options as AVAudioPlayerNodeBufferOptions, completionHandler as iosBlock = nil)
		  scheduleBufferAtTime (id, buffer.id, atTime.id, options, if (completionHandler = nil, nil, completionHandler.Handle))
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub SchedulePlayback(Buffer as AppleAVAudioPCMBuffer, completionHandler as iosBlock = nil)
		  scheduleBuffer (id, buffer.id, if (completionHandler = nil, nil, completionHandler.Handle))
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub ScheduleSegment(AVFile as AppleAVAudioFile, StartingFrame As Int64, FrameCount As UInt32, atTime as AppleAVAudioTime, completionHandler as iosBlock = nil)
