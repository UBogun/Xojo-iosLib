#tag Class
Protected Class AppleSecurityIdentity
Inherits AppleCFObject
	...
	#tag Method, Flags = &h0
		 Shared Function makefromCFTypeRef(aCFTypeRef as ptr) As AppleSecurityIdentity
		  return if (aCFTypeRef = nil, nil, new AppleSecurityIdentity(aCFTypeRef))
		End Function
	#tag EndMethod
