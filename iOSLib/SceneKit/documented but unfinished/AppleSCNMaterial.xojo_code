...
Inherits AppleObject
	#tag Method, Flags = &h1000, Description = 437265617465732061206E6577206D6174657269616C206F626A6563742E
		Sub Constructor()
		  Declare function material lib SceneKitLib selector "material" (id as ptr) as ptr
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function gettransparency Lib SceneKitLib Selector "transparency" (id as ptr) As cgfloat
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Sub settransparency Lib SceneKitLib Selector "settransparency:" (id as ptr, value as cgfloat)
	#tag EndExternalMethod
	...
	#tag ComputedProperty, Flags = &h0, Description = 416E206F626A6563742074686174206D616E6167657320746865206D6174657269616CE280997320726573706F6E736520746F20616D6269656E74206C69676874696E672E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  Declare function ambient lib SceneKitLib selector "ambient" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0, Description = 
		#tag Getter
			Get
			  if RespondsToSelector(classptr, "ambientOcclusion") then
			    Declare function ambientOcclusion lib SceneKitLib selector "ambientOcclusion" (id as ptr) as ptr
			    return  AppleSCNMaterialProperty.MakefromPtr (ambientOcclusion (id))
			  end if
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 
		#tag Getter
			Get
			  if RespondsToSelector (Classptr, "blendMode") then
			    Declare function blendMode lib SceneKitLib selector "blendMode" (id as ptr) as SCNBlendMode
			    return  blendMode (id)
			  end if
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  if RespondsToSelector(classptr, "setBlendMode:") then
			    Declare sub setblendMode lib SceneKitLib selector "setBlendMode:" (id as ptr, value as SCNBlendMode)
	...
	#tag ComputedProperty, Flags = &h0, Description = 546865206D6F64652064657465726D696E696E67207768696368206661636573206F6620612073757266616365205363656E654B69742072656E646572732E20416E696D617461626C652E
		#tag Getter
			Get
			  Declare function cullMode lib SceneKitLib selector "cullMode" (id as ptr) as SCNCullMode
			  return  cullMode (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  Declare sub setcullMode lib SceneKitLib selector "setCullMode:" (id as ptr, value as SCNCullMode)
	...
	#tag ComputedProperty, Flags = &h0, Description = 416E206F626A6563742074686174206D616E6167657320746865206D6174657269616CE2809973206469666675736520726573706F6E736520746F206C69676874696E672E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  Declare function diffuse lib SceneKitLib selector "diffuse" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0, Description = 57686574686572205363656E654B69742073686F756C642072656E64657220626F74682066726F6E7420616E64206261636B206661636573206F66206120737572666163652E20416E696D617461626C652E
		#tag Getter
			Get
			  Declare function DoubleSided lib SceneKitLib selector "isDoubleSided" (id as ptr) as Boolean
		...
		#tag Setter
			Set
			  Declare sub setDoubleSided lib SceneKitLib selector "setDoubleSided:" (id as ptr, value as Boolean)
	...
	#tag ComputedProperty, Flags = &h0, Description = 416E206F626A656374207468617420646566696E65732074686520636F6C6F7220656D6974746564206279206561636820706F696E74206F6E206120737572666163652E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  Declare function emission lib SceneKitLib selector "emission" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0, Description = 546865206C69676874696E6720666F726D756C612074686174205363656E654B6974207573657320746F2072656E64657220746865206D6174657269616C2E
		#tag Getter
			Get
			  Declare function lightingModelName lib SceneKitLib selector "lightingModelName" (id as ptr) as CFStringRef
			  return  lightingModelName (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  Declare sub setlightingModelName lib SceneKitLib selector "setLightingModelName:" (id as ptr, value as cfstringref)
	...
	#tag ComputedProperty, Flags = &h0, Description = 57686574686572205363656E654B697420706572666F726D73206C69676874696E672063616C63756C6174696F6E732070657220766572746578206F722070657220706978656C2E20416E696D617461626C652E
		#tag Getter
			Get
			  Declare function litPerPixel lib SceneKitLib selector "isLitPerPixel" (id as ptr) as Boolean
		...
		#tag Setter
			Set
			  Declare sub setlitPerPixel lib SceneKitLib selector "setLitPerPixel:" (id as ptr, value as Boolean)
	...
	#tag ComputedProperty, Flags = &h0, Description = 5768657468657220746865206D6174657269616C20726573706F6E6473206964656E746963616C6C7920746F20626F746820616D6269656E7420616E642064696666757365206C69676874696E672E20416E696D617461626C652E
		#tag Getter
			Get
			  Declare function locksAmbientWithDiffuse lib SceneKitLib selector "locksAmbientWithDiffuse" (id as ptr) as Boolean
		...
		#tag Setter
			Set
			  Declare sub setlocksAmbientWithDiffuse lib SceneKitLib selector "setLocksAmbientWithDiffuse:" (id as ptr, value as Boolean)
	...
	#tag ComputedProperty, Flags = &h0, Description = 
		#tag Getter
			Get
			  Declare function multiply lib SceneKitLib selector "multiply" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0, Description = 416E206F626A656374207468617420646566696E657320746865206E6F6D696E616C206F7269656E746174696F6E206F66207468652073757266616365206174206561636820706F696E7420666F722075736520696E206C69676874696E672E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  Declare function normal lib SceneKitLib selector "normal" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0, Description = 57686574686572205363656E654B6974207573657320646570746820696E666F726D6174696F6E207768656E2072656E646572696E6720746865206D6174657269616C2E
		#tag Getter
			Get
			  Declare function readsFromDepthBuffer lib SceneKitLib selector "readsFromDepthBuffer" (id as ptr) as Boolean
		...
		#tag Setter
			Set
			  Declare sub setreadsFromDepthBufferr lib SceneKitLib selector "setReadsFromDepthBuffer:" (id as ptr, value as Boolean)
	...
	#tag ComputedProperty, Flags = &h0, Description = 416E206F626A656374207468617420646566696E657320746865207265666C656374656420636F6C6F7220666F72206561636820706F696E74206F6E206120737572666163652E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  Declare function reflective lib SceneKitLib selector "reflective" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0, Description = 
		#tag Getter
			Get
			  if RespondsToSelector (classptr, "selfIllumination") then
			    Declare function selfIllumination lib SceneKitLib selector "selfIllumination" (id as ptr) as ptr
			    return  AppleSCNMaterialProperty.MakefromPtr (selfIllumination (id))
			  end if
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 416E206F626A6563742074686174206D616E6167657320746865206D6174657269616CE28099732073706563756C617220726573706F6E736520746F206C69676874696E672E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  Declare function specular lib SceneKitLib selector "specular" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0, Description = 546865206D6F6465205363656E654B6974207573657320746F2063616C63756C617465207472616E73706172656E637920666F7220746865206D6174657269616C2E2044656661756C7420414F6E652E
		#tag Getter
			Get
			  Declare function transparencyMode lib SceneKitLib selector "transparencyMode" (id as ptr) as SCNTransparencyMode
			  return  transparencyMode (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  Declare sub setTransparencyMode lib SceneKitLib selector "setTransparencyMode:" (id as ptr, value as SCNTransparencyMode)
	...
	#tag ComputedProperty, Flags = &h0, Description = 416E206F626A65637420746861742064657465726D696E657320746865206F706163697479206F66206561636820706F696E7420696E2061206D6174657269616C2E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  Declare function transparent lib SceneKitLib selector "transparent" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0, Description = 57686574686572205363656E654B69742070726F647563657320646570746820696E666F726D6174696F6E207768656E2072656E646572696E6720746865206D6174657269616C2E
		#tag Getter
			Get
			  Declare function writesToDepthBuffer lib SceneKitLib selector "writesToDepthBuffer" (id as ptr) as Boolean
		...
		#tag Setter
			Set
			  Declare sub setwritesToDepthBuffer lib SceneKitLib selector "setWritesToDepthBuffer:" (id as ptr, value as Boolean)
