...
Inherits AppleSCNGeometry
	...
	#tag Method, Flags = &h1000, Description = 43726561746573206120636F6E652067656F6D6574727920776974682074686520676976656E20746F70207261646975732C20626F74746F6D207261646975732C20616E64206865696768742E
		Sub Constructor(TopRadius As Double, BottomRadius As Double, Height As Double)
		  #if Target64Bit
		    Declare function coneWithTopRadius lib SceneKitLib selector "coneWithTopRadius:bottomRadius:height:" (id as ptr, TopRadius as double, BottomRadius As Double, Height as double) as ptr
		  #elseif Target32Bit
		    Declare function coneWithTopRadius lib SceneKitLib selector "coneWithTopRadius:bottomRadius:height:" (id as ptr, TopRadius as single, BottomRadius As single, Height as single) as ptr
		  #endif
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNCone")
			  return mClassPtr
			End Get
		#tag EndGetter
