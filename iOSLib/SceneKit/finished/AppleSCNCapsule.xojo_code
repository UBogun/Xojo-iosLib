...
Inherits AppleSCNGeometry
	...
	#tag Method, Flags = &h1000, Description = 4372656174657320612063617073756C652067656F6D65747279207769746820746865207370656369666965642072616469757320616E64206865696768742E
		Sub Constructor(CapRadius As Double, Height As Double)
		  #if Target64Bit
		    Declare function capsuleWithCapRadius lib SceneKitLib selector "capsuleWithCapRadius:height:" (id as ptr, CapRadius as double, Height as double) as ptr
		  #elseif Target32Bit
		    Declare function capsuleWithCapRadius lib SceneKitLib selector "capsuleWithCapRadius:height:" (id as ptr, CapRadius as single, Height as single) as ptr
		  #endif
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNCapsule")
			  return mClassPtr
			End Get
		#tag EndGetter
