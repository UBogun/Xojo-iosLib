#tag Class
Protected Class AppleSCNPhysicsShapeOptionDictionary
Inherits AppleMutabledictionary
	...
	#tag ComputedProperty, Flags = &h0, Description = 5768657468657220746F2063726561746520612067726F7570206F6620696E646570656E64656E7420736861706573206F7220636F6D62696E65207468656D20696E746F20612073696E676C652073686170652E
		#tag Getter
			Get
			  dim value as AppleNumber = applenumber.MakefromPtr (me.ValueForKey(AppleSCNPhysicsShape.kSCNPhysicsShapeKeepAsCompoundKey))
			  if value <> nil then return value.BoolValue
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  me.SetObjectForKeyName (AppleSCNPhysicsShape.kSCNPhysicsShapeKeepAsCompoundKey , new AppleNumber(value))
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 
		#tag Getter
			Get
			  dim value as AppleValue = AppleValue.MakefromPtr (me.ValueForKey(AppleSCNPhysicsShape.kSCNPhysicsShapeScaleKey))
			  if value <> nil then return value.SCNVector3Value
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  me.SetObjectForKeyName (AppleSCNPhysicsShape.kSCNPhysicsShapeScaleKey , SceneKitFrameWork.MakeAppleValue(value))
			End Set
		#tag EndSetter
		Scale As SCNVector3
	#tag EndComputedProperty
