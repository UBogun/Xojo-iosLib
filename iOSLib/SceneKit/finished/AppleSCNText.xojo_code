...
Inherits AppleSCNGeometry
	...
	#tag Method, Flags = &h1000, Description = 43726561746573206120746578742067656F6D657472792066726F6D20612073706563696669656420737472696E672C20657874727564656420776974682061207370656369666965642064657074682E
		Sub Constructor(aText As appleAttributedString, extrusionDepth As Double)
		  #if Target64Bit
		    Declare function textWithString lib SceneKitLib selector "textWithString:extrusionDepth:" (id as ptr, atext as ptr, extrusionDepth as double) as ptr
		  #elseif Target32Bit
		    Declare function textWithString lib SceneKitLib selector "textWithString:extrusionDepth:" (id as ptr, atext as ptr, extrusionDepth as single) as ptr
		  #endif
	...
	#tag Method, Flags = &h1000, Description = 43726561746573206120746578742067656F6D657472792066726F6D20612073706563696669656420737472696E672C20657874727564656420776974682061207370656369666965642064657074682E
		Sub Constructor(aText As CFStringRef, extrusionDepth As Double)
		  #if Target64Bit
		    Declare function textWithString lib SceneKitLib selector "textWithString:extrusionDepth:" (id as ptr, atext as cfstringref, extrusionDepth as double) as ptr
		  #elseif Target32Bit
		    Declare function textWithString lib SceneKitLib selector "textWithString:extrusionDepth:" (id as ptr, atext as cfstringref, extrusionDepth as single) as ptr
		  #endif
	...
	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getAttributedString Lib SceneKitLib Selector "string" (id as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getfont Lib SceneKitLib Selector "font" (id as ptr) As Ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getString Lib SceneKitLib Selector "string" (id as ptr) As cfstringref
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Sub setAttributedString Lib SceneKitLib Selector "setString:" (id as ptr, value as ptr)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Sub setfont Lib SceneKitLib Selector "setFont:" (id as ptr, value as Ptr)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Sub setString Lib SceneKitLib Selector "setString:" (id as ptr, value as cfstringref)
	#tag EndExternalMethod
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNText")
			  return mClassPtr
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 412072656374616E676C652073706563696679696E6720746865206172656120696E207768696368205363656E654B69742073686F756C64206C6179206F75742074686520746578742E
		#tag Getter
			Get
			  #if Target64Bit
			    return getcontainerFrame(id)
			  #elseif Target32Bit
			    return getcontainerFrame32(id).tonsrect
			  #endif
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  #if Target64Bit
			    setcontainerFrame(id, value)
			  #elseif Target32Bit
			    setcontainerFrame32(id, value.tonsrect32)
			  #endif
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 41206E756D62657220746861742064657465726D696E657320746865206163637572616379206F7220736D6F6F74686E657373206F662074686520746578742067656F6D657472792E2044656661756C7420302E362E
		#tag Getter
			Get
			  #if Target64Bit
			    Declare function flatness lib SceneKitLib selector "flatness" (id as ptr) as Double
			  #elseif Target32Bit
			    Declare function flatness lib SceneKitLib selector "flatness" (id as ptr) as Single
			  #endif
			  return flatness (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  #if Target64Bit
			    Declare Sub setFlatness lib SceneKitLib selector "setFlatness:" (id as ptr, value as Double)
			  #elseif Target32Bit
			    Declare Sub setFlatness lib SceneKitLib selector "setFlatness:" (id as ptr, value as Single)
			  #endif
	...
	#tag ComputedProperty, Flags = &h0, Description = 486F77205363656E654B6974207472756E63617465732074657874207468617420697320746F6F206C6F6E6720746F206669742069747320636F6E7461696E65722E2053657473205472756E636174696F6E4D6F646520616E64205772617070656420696E7465726E616C6C792E
		#tag Getter
			Get
		...
		#tag Setter
			...
			End Set
		#tag EndSetter
		LineBreakMode As AppleLabel.NSLineBreakMode
	#tag EndComputedProperty

	#tag ComputedProperty, Flags = &h0, Description = 486F77205363656E654B697420686F72697A6F6E74616C6C7920616C69676E732065616368206C696E65206F6620746578742077697468696E2069747320636F6E7461696E65722E205365747320746865207072697661746520416C69676E6D656E74206D6F646520636F6E7374616E7420696E7465726E616C6C792E
		#tag Getter
			Get
	...
	#tag ComputedProperty, Flags = &h0, Description = 57686574686572205363656E654B6974207772617073206C6F6E67206C696E6573206F6620746578742E
		#tag Getter
			Get
			  declare Function isWrapped lib SceneKitLib selector "isWrapped" (id as ptr) as Boolean
			  return isWrapped (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare sub setWrapped lib SceneKitLib selector "setWrapped:" (id as ptr, value as Boolean)
			  setWrapped (id, value)
			End Set
		#tag EndSetter
		Wrapped As Boolean
