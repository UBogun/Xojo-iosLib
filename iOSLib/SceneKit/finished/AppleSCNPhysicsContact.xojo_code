...
Inherits AppleSCNObject
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getcollisionImpulse Lib SceneKitLib Selector "collisionImpulse" (id as ptr) As CGFloat
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getcontactNormal Lib SceneKitLib Selector "contactNormal" (id as ptr) As SCNVector3
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getcontactNormal32 Lib SceneKitLib Selector "contactNormal" (id as ptr) As SCNVector3_32Bit
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getcontactPoint Lib SceneKitLib Selector "contactPoint" (id as ptr) As SCNVector3
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getcontactPoint32 Lib SceneKitLib Selector "contactPoint" (id as ptr) As SCNVector3_32Bit
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getnodeA Lib SceneKitLib Selector "nodeA" (id as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getnodeB Lib SceneKitLib Selector "nodeB" (id as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getpenetrationDistance Lib SceneKitLib Selector "penetrationDistance" (id as ptr) As CGFloat
	#tag EndExternalMethod
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNPhysicsContact")
			  return mClassPtr
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 546865206E6F726D616C20766563746F722061742074686520636F6E7461637420706F696E74206265747765656E207468652074776F207068797369637320626F646965732C20696E207363656E6520636F6F7264696E617465732E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  #if Target64Bit
			    return getcontactNormal(id)
			  #elseif Target32Bit
			    return getcontactNormal32(id).toVector3
			  #endif
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 54686520636F6E7461637420706F696E74206265747765656E207468652074776F207068797369637320626F646965732C20696E207363656E6520636F6F7264696E617465732E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  #if Target64Bit
			    return getcontactPoint(id)
			  #elseif Target32Bit
			    return getcontactPoint32(id).toVector3
			  #endif
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 546865206E6F646520636F6E7461696E696E672074686520666972737420626F647920696E2074686520636F6E746163742E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  return AppleSCNNode.MakefromPtr(getnodea(id))
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 546865206E6F646520636F6E7461696E696E6720746865207365636F6E6420626F647920696E2074686520636F6E746163742E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  return AppleSCNNode.MakefromPtr(getnodeb(id))
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 54686520666F726365206F7665722074696D65206F662074686520636F6C6C6973696F6E2C20696E206E6577746F6E2D7365636F6E64732E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  return getpenetrationDistance(id)
			End Get
		#tag EndGetter
