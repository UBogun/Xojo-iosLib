...
Inherits AppleObject
	...
	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getfaceIndex Lib SceneKitLib Selector "faceIndex" (id as ptr) As Integer
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getgeometryIndex Lib SceneKitLib Selector "geometryIndex" (id as ptr) As Integer
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getlocalCoordinates Lib SceneKitLib Selector "localCoordinates" (id as ptr) As SCNVector3
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getlocalCoordinates32 Lib SceneKitLib Selector "localCoordinates" (id as ptr) As SCNVector3_32Bit
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getlocalNormal Lib SceneKitLib Selector "localNormal" (id as ptr) As SCNVector3
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getlocalNormal32 Lib SceneKitLib Selector "localNormal" (id as ptr) As SCNVector3_32Bit
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getmodelTransform Lib SceneKitLib Selector "modelTransform" (id as ptr) As SCNMatrix4
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getworldCoordinates Lib SceneKitLib Selector "worldCoordinates" (id as ptr) As SCNVector3
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getworldCoordinates32 Lib SceneKitLib Selector "worldCoordinates" (id as ptr) As SCNVector3_32Bit
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getworldNormal Lib SceneKitLib Selector "worldNormal" (id as ptr) As SCNVector3
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getworldNormal32 Lib SceneKitLib Selector "worldNormal" (id as ptr) As SCNVector3_32Bit
	#tag EndExternalMethod
	...
	#tag Method, Flags = &h0, Description = 52657475726E7320746865207465787475726520636F6F7264696E617465732061742074686520706F696E74206F6620696E74657273656374696F6E20666F7220746865207370656369666965642074657874757265206D617070696E67206368616E6E656C2E
		Function TextureCoordiinates(Channel as Integer) As FoundationFrameWork.NSPoint
		  #if Target64Bit
		    return textureCoordinatesWithMappingChannel(id, channel)
		  #elseif Target32Bit
		    return textureCoordinatesWithMappingChannel32(id, channel).tonspoint
		  #endif
		End Function
	#tag EndMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function textureCoordinatesWithMappingChannel Lib SceneKitLib Selector "textureCoordinatesWithMappingChannel:" (id as ptr, channel as integer) As FoundationFrameWork.nspoint
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function textureCoordinatesWithMappingChannel32 Lib SceneKitLib Selector "textureCoordinatesWithMappingChannel:" (id as ptr, channel as integer) As FoundationFrameWork.nspoint32Bit
	#tag EndExternalMethod
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNHitTestResult")
			  return mClassPtr
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 
		#tag Getter
			Get
			  #if Target64Bit
			    return getlocalCoordinates (id)
			  #elseif Target32Bit
			    return getlocalCoordinates32(id).toVector3
			  #endif
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 
		#tag Getter
			Get
			  #if Target64Bit
			    return getlocalNormal (id)
			  #elseif Target32Bit
			    return getlocalNormal32(id).toVector3
			  #endif
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 546865206E6F64652077686F73652067656F6D6574727920696E74657273656374732074686520736561726368207261792E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  return applescnnode.MakefromPtr(SceneKitFrameWork.getnode(id))
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 54686520706F696E74206F6620696E74657273656374696F6E206265747765656E207468652067656F6D6574727920616E642074686520736561726368207261792C20696E20746865207363656E65E280997320776F726C6420636F6F7264696E6174652073797374656D2E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  #if Target64Bit
			    return getworldCoordinates (id)
			  #elseif Target32Bit
			    return getworldCoordinates32(id).toVector3
			  #endif
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 5468652073757266616365206E6F726D616C20766563746F722061742074686520706F696E74206F6620696E74657273656374696F6E2C20696E20746865207363656E65E280997320776F726C6420636F6F7264696E6174652073797374656D2E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  #if Target64Bit
			    return getworldNormal (id)
			  #elseif Target32Bit
			    return getworldNormal32(id).toVector3
			  #endif
			End Get
		#tag EndGetter
