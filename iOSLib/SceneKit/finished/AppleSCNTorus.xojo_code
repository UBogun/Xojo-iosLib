...
Inherits AppleSCNGeometry
	...
	#tag Method, Flags = &h1000, Description = 43726561746573206120746F7275732067656F6D65747279207769746820746865207370656369666965642072696E672072616469757320616E642070697065207261646975732E
		Sub Constructor(RingRadius As Double, PipeRadius As Double)
		  #if Target64Bit
		    Declare function torusWithRingRadius lib SceneKitLib selector "torusWithRingRadius:pipeRadius:" (id as ptr, RingRadius as double, PipeRadius As Double) as ptr
		  #elseif Target32Bit
		    Declare function torusWithRingRadius lib SceneKitLib selector "torusWithRingRadius:pipeRadius" (id as ptr, RingRadius as single, PipeRadius As Single) as ptr
		  #endif
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNTorus")
			  return mClassPtr
			End Get
		#tag EndGetter
