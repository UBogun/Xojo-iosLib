...
Inherits AppleSCNGeometry
	...
	#tag Method, Flags = &h1000, Description = 4372656174657320612063796C696E6465722067656F6D65747279207769746820746865207370656369666965642072616469757320616E64206865696768742E
		Sub Constructor(Radius As Double, Height As Double)
		  #if Target64Bit
		    Declare function cylinderWithRadius lib SceneKitLib selector "cylinderWithRadius:height:" (id as ptr, Radius as double, Height as double) as ptr
		  #elseif Target32Bit
		    Declare function cylinderWithRadius lib SceneKitLib selector "cylinderWithRadius:height:" (id as ptr, Radius as single, Height as single) as ptr
		  #endif
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNCylinder")
			  return mClassPtr
			End Get
		#tag EndGetter
