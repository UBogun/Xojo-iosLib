...
Inherits AppleSCNGeometry
	...
	#tag Method, Flags = &h1000, Description = 4372656174657320612073686170652067656F6D6574727920776974682074686520737065636966696564207061746820616E6420657874727573696F6E2064657074682E
		Sub Constructor(Path As AppleBezierpath, extrusionDepth As Double)
		  #if Target64Bit
		    Declare function shapeWithPath lib SceneKitLib selector "shapeWithPath:extrusionDepth:" (id as ptr, Path as ptr, extrusionDepth as double) as ptr
		  #elseif Target32Bit
		    Declare function shapeWithPath lib SceneKitLib selector "shapeWithPath:extrusionDepth:" (id as ptr, Path as Ptr, extrusionDepth as single) as ptr
		  #endif
	...
	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getchamferMode Lib SceneKitLib Selector "chamferMode" (id as ptr) As SCNChamferMode
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Sub setchamferMode Lib SceneKitLib Selector "setChamferMode:" (id as ptr, value as SCNChamferMode)
	#tag EndExternalMethod
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNShape")
			  return mClassPtr
			End Get
		#tag EndGetter
