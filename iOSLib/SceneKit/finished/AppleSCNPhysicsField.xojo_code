...
Inherits AppleObject
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function customFieldWithEvaluationBlock Lib SceneKitLib Selector "customFieldWithEvaluationBlock:" (id as ptr, block as ptr) As ptr
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function dragField Lib SceneKitLib Selector "dragField" (id as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function electricField Lib SceneKitLib Selector "electricField" (id as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getactive Lib SceneKitLib Selector "isActive" (id as ptr) As Boolean
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getdirection Lib SceneKitLib Selector "direction" (id as ptr) As SCNVector3
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getdirection32 Lib SceneKitLib Selector "direction" (id as ptr) As SCNVector3_32Bit
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getexclusive Lib SceneKitLib Selector "isExclusive" (id as ptr) As Boolean
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getfalloffExponent Lib SceneKitLib Selector "falloffExponent" (id as ptr) As cgfloat
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function gethalfExtent Lib SceneKitLib Selector "halfExtent" (id as ptr) As SCNVector3
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function gethalfExtent32 Lib SceneKitLib Selector "halfExtent" (id as ptr) As SCNVector3_32Bit
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getoffset Lib SceneKitLib Selector "offset" (id as ptr) As SCNVector3
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getoffset32 Lib SceneKitLib Selector "offset" (id as ptr) As SCNVector3_32Bit
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getscope Lib SceneKitLib Selector "scope" (id as ptr) As SCNPhysicsFieldScope
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getstrength Lib SceneKitLib Selector "strength" (id as ptr) As cgfloat
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getusesEllipsoidalExtent Lib SceneKitLib Selector "usesEllipsoidalExtent" (id as ptr) As Boolean
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function linearGravityField Lib SceneKitLib Selector "linearGravityField" (id as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function magneticField Lib SceneKitLib Selector "springField" (id as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function noiseFieldWithSmoothness Lib SceneKitLib Selector "noiseFieldWithSmoothness:animationSpeed:" (id as ptr, Smoothness as cgfloat, speed as cgfloat) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function radialGravityField Lib SceneKitLib Selector "dragField" (id as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setactive Lib SceneKitLib Selector "setActive:" (id as ptr, value as Boolean)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setdirection Lib SceneKitLib Selector "setDirection:" (id as ptr, value as SCNVector3)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setdirection32 Lib SceneKitLib Selector "setDirection:" (id as ptr, value as SCNVector3_32Bit)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setexclusive Lib SceneKitLib Selector "setExclusive:" (id as ptr, value as Boolean)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Sub setfalloffExponent Lib SceneKitLib Selector "setFalloffExponent:" (id as ptr, value as cgfloat)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub sethalfExtent Lib SceneKitLib Selector "setHalfExtent:" (id as ptr, value as SCNVector3)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub sethalfExtent32 Lib SceneKitLib Selector "setHalfExtent:" (id as ptr, value as SCNVector3_32Bit)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setoffset Lib SceneKitLib Selector "setOffset:" (id as ptr, value as SCNVector3)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setoffset32 Lib SceneKitLib Selector "setOffset:" (id as ptr, value as SCNVector3_32Bit)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setscope Lib SceneKitLib Selector "setScope:" (id as ptr, value as SCNPhysicsFieldScope)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Sub setstrength Lib SceneKitLib Selector "setStrength:" (id as ptr, value as cgfloat)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setusesEllipsoidalExtent Lib SceneKitLib Selector "setUsesEllipsoidalExtent:" (id as ptr, value as Boolean)
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function springField Lib SceneKitLib Selector "springField" (id as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function turbulenceFieldWithSmoothness Lib SceneKitLib Selector "turbulenceFieldWithSmoothness:animationSpeed:" (id as ptr, Smoothness as cgfloat, speed as cgfloat) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function vortexField Lib SceneKitLib Selector "vortexField" (id as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNPhysicsField")
			  return mClassPtr
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 546865206669656C64E280997320646972656374696F6E616C20617869732E
		#tag Getter
			Get
			  ...
			  #elseif Target32Bit
			    return getdirection32(id).toVector3
			  #endif
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  ...
			  #elseif Target32Bit
			    setdirection32 id, value.toVector3_32
			  #endif
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 416E206578706F6E656E7420746861742064657465726D696E657320686F7720746865206669656C64E280997320737472656E6774682064696D696E697368657320776974682064697374616E63652E
		#tag Getter
			Get
			  return getfalloffExponent(id)
			  
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  setfalloffExponent id, value
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 
		#tag Getter
			Get
			  #if Target64Bit
			    return gethalfExtent(id)
			  #elseif Target32Bit
			    return gethalfExtent32(id).toVector3
			  #endif
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  #if Target64Bit
			    sethalfExtent id, value
			  #elseif Target32Bit
			    sethalfExtent32 id, value.toVector3_32
			  #endif
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 546865206F6666736574206F6620746865206669656C64E28099732063656E7465722077697468696E206974732061726561206F66206566666563742E
		#tag Getter
			Get
			    ...
			    return getoffset(id)
			  #elseif Target32Bit
			    return getoffset32(id).toVector3
			  #endif
			End Get
		#tag EndGetter
		#tag Setter
			Set
			    ...
			    setoffset id, value
			  #elseif Target32Bit
			    setoffset32 id, value.toVector3_32
			  #endif
			End Set
		#tag EndSetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 4120426F6F6C65616E2076616C756520746861742064657465726D696E6573207768657468657220746865206669656C64E28099732061726561206F662065666665637420697320736861706564206C696B65206120626F78206F7220656C6C6970736F69642E
		#tag Getter
			Get
			  return getusesEllipsoidalExtent(id)
			  
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  setusesEllipsoidalExtent id, value
			End Set
		#tag EndSetter
