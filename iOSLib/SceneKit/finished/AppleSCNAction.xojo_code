...
Inherits AppleObject
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function customActionWithDuration Lib SceneKitLib Selector "customActionWithDuration:actionBlock:" (id as ptr, duration as double, block as ptr) As ptr
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function fadeInWithDuration Lib SceneKitLib Selector "fadeInWithDuration:" (id as ptr, duration as double) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function fadeOpacityBy Lib SceneKitLib Selector "fadeOpacityBy:duration:" (id as ptr, opacity as cgfloat, duration as double) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function fadeOpacityTo Lib SceneKitLib Selector "fadeOpacityTo:duration:" (id as ptr, opacity as cgfloat, duration as double) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function fadeOutWithDuration Lib SceneKitLib Selector "fadeOutWithDuration:" (id as ptr, duration as double) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function gettimingMode Lib SceneKitLib Selector "timingMode" (id as ptr) As SCNActionTimingMode
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function group_ Lib SceneKitLib Selector "group:" (id as ptr, groupID as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag Method, Flags = &h0, Description = 4372656174657320616E20616374696F6E20746861742068696465732061206E6F64652E20417661696C61626C6520696E20694F5320392E3020616E64206C617465722E
		 Shared Function Hide() As AppleSCNAction
		  if RespondsToSelector(ClassPtr, "hide") then
		    dim result as  new AppleSCNAction (hide(classptr))
		    result.retainclassobject
		    return result
		  end if
		End Function
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function hide Lib SceneKitLib Selector "hide" (id as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function javaScriptActionWithScript Lib SceneKitLib Selector "javaScriptActionWithScript:duration:" (id as ptr, script as cfstringref, duration as double) As ptr
	#tag EndExternalMethod
	...
	#tag Method, Flags = &h0, Description = 4372656174657320616E20616374696F6E2074686174206D6F7665732061206E6F64652072656C617469766520746F206974732063757272656E7420706F736974696F6E2E
		 Shared Function MoveBy(Delta as SCNVEctor3, Duration as Double) As AppleSCNAction
		  dim result as AppleSCNAction
		  #if Target64Bit
		    result = new AppleSCNAction (moveByDelta(classptr, Delta, Duration))
		  #elseif Target32Bit
		    result = new AppleSCNAction (moveByDelta32(classptr, Delta.toVector3_32, Duration))
		  #endif
		  result.retainclassobject
		  return result
		End Function
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function moveByDelta Lib SceneKitLib Selector "moveBy:duration:" (id as ptr, Delta as SCNVector3, duration as double) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function moveByDelta32 Lib SceneKitLib Selector "moveBy:duration:" (id as ptr, Delta as SCNVector3_32Bit, duration as double) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function moveByX Lib SceneKitLib Selector "moveByX:y:z:duration:" (id as ptr, x as cgfloat, y as cgfloat, z as cgfloat, duration as double) As ptr
	#tag EndExternalMethod
	...
	#tag Method, Flags = &h0, Description = 4372656174657320616E20616374696F6E2074686174206D6F7665732061206E6F646520746F2061206E657720706F736974696F6E2E
		 Shared Function MoveTo(Location as SCNVEctor3, Duration as Double) As AppleSCNAction
		  dim result as AppleSCNAction
		  #if Target64Bit
		    result = new AppleSCNAction (moveToPos(classptr, Location, Duration))
		  #elseif Target32Bit
		    result = new AppleSCNAction (moveToPos32(classptr,location.toVector3_32, Duration))
		  #endif
		  result.retainclassobject
		  return result
		End Function
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function moveToPos Lib SceneKitLib Selector "moveTo:duration:" (id as ptr, Location as SCNVector3, duration as double) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function moveToPos32 Lib SceneKitLib Selector "moveTo:duration:" (id as ptr, Location as SCNVector3_32Bit, duration as double) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function playAudioSource Lib SceneKitLib Selector "playAudioSource:waitForCompletion:" (id as ptr, source as ptr, Waitforcompletion as Boolean) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function removeFromParentNode Lib SceneKitLib Selector "removeFromParentNode" (id as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function repeatAction Lib SceneKitLib Selector "repeatAction:count:" (id as ptr, action as ptr, count as uinteger) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function repeatActionForever Lib SceneKitLib Selector "repeatActionForever:" (id as ptr, action as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function reversedAction Lib SceneKitLib Selector "reversedAction" (id as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag Method, Flags = &h0, Description = 4372656174657320616E20616374696F6E207468617420726F746174657320746865206E6F646520627920616E20616E676C652061726F756E642061207370656369666965642061786973
		 Shared Function RotateBy(Angle as Double, AroundAxis As SCNVector3, Duration as Double) As AppleSCNAction
		  dim result as AppleSCNAction
		  #if Target64Bit
		    result = new AppleSCNAction (rotateByAngle(classptr, angle, AroundAxis, Duration))
		  #elseif Target32Bit
		    result = new AppleSCNAction (rotateByAngle32(classptr, angle, AroundAxis.toVector3_32, Duration))
		  #endif
		  result.retainclassobject
		  return result
		End Function
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function rotateByAngle Lib SceneKitLib Selector "rotateByAngle:aroundAxis:duration:" (id as ptr, angle as double, aroundAxis as SCNVEctor3, duration as double) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function rotateByAngle32 Lib SceneKitLib Selector "rotateByAngle:aroundAxis:duration:" (id as ptr, angle as single, aroundAxis as SCNVEctor3_32Bit, duration as double) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function rotateByX Lib SceneKitLib Selector "rotateByX:y:z:duration:" (id as ptr, x as cgfloat, y as cgfloat, z as cgfloat, duration as double) As ptr
	#tag EndExternalMethod
	...
	#tag Method, Flags = &h0, Description = 4372656174657320616E20616374696F6E207468617420726F746174657320746865206E6F646520746F20616E206162736F6C75746520616E676C652061726F756E6420612073706563696669656420617869732E
		 Shared Function RotateTo(AxisAngle as SCNVector4, Duration as Double) As AppleSCNAction
		  dim result as AppleSCNAction
		  #if Target64Bit
		    result = new AppleSCNAction (rotateToAxis(classptr, AxisAngle, Duration))
		  #elseif Target32Bit
		    result = new AppleSCNAction (rotateToAxis32(classptr, AxisAngle.toVector4_32, Duration))
		  #endif
		  result.retainclassobject
		  return result
		End Function
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function rotateToAxis Lib SceneKitLib Selector "rotateToAxisAngle:duration:" (id as ptr, axisAngle as SCNVector4, duration as double) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function rotateToAxis32 Lib SceneKitLib Selector "rotateToAxisAngle:duration:" (id as ptr, axisAngle as SCNVector4_32Bit, duration as double) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function rotateToX Lib SceneKitLib Selector "rotateToX:y:z:duration:shortestUnitArc:" (id as ptr, x as cgfloat, y as cgfloat, z as cgfloat, duration as double, shortestUnitArc as Boolean) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function runBlock Lib SceneKitLib Selector "runBlock:" (id as ptr, block as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function runBlockOnQueue Lib SceneKitLib Selector "runBlock:queue:" (id as ptr, block as ptr, dispatch_queue as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function scaleBy Lib SceneKitLib Selector "scaleBy:duration:" (id as ptr, scale as cgfloat, duration as double) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function scaleTo Lib SceneKitLib Selector "scaleTo:duration:" (id as ptr, scale as cgfloat, duration as double) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function sequence_ Lib SceneKitLib Selector "sequence:" (id as ptr, groupID as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Sub settimingFunction Lib SceneKitLib Selector "setTimingFunction:" (id as ptr, block as ptr)
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Sub settimingMode Lib SceneKitLib Selector "setTimingMode:" (id as ptr, value as SCNActionTimingMode)
	#tag EndExternalMethod
	...
	#tag Method, Flags = &h0, Description = 4372656174657320616E20616374696F6E207468617420656E73757265732061206E6F6465206973206E6F742068696464656E2E20417661696C61626C6520696E20694F5320392E3020616E64206C617465722E
		 Shared Function Unhide() As AppleSCNAction
		  if RespondsToSelector(ClassPtr, "unhide") then
		    dim result as  new AppleSCNAction (unhide(classptr))
		    result.retainclassobject
		    return result
		  end if
		End Function
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function unhide Lib SceneKitLib Selector "unhide" (id as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function waitForDuration Lib SceneKitLib Selector "waitForDuration:" (id as ptr, duration as double) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h21, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Private Declare Function waitForDurationwithRange Lib SceneKitLib Selector "waitForDuration:withRange:" (id as ptr, duration as double, durationRange as double) As ptr
	#tag EndExternalMethod
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNAction")
			  return mClassPtr
			End Get
		#tag EndGetter
