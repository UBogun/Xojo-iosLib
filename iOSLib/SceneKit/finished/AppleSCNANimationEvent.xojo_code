...
Inherits AppleObject
	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function animationEventWithKeyTime Lib SceneKitLib Selector "animationEventWithKeyTime:eventBlock:" (id as ptr, Time As CGFloat, Block as Ptr) As ptr
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNAnimationEvent")
			  return mClassPtr
			End Get
		#tag EndGetter
