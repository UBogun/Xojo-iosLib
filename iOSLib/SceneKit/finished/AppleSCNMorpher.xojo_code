...
Inherits AppleObject
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getcalculationMode Lib SceneKitLib Selector "calculationMode" (id as ptr) As SCNMorpherCalculationMode
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getTargets Lib SceneKitLib Selector "targets" (id as ptr) As Ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getWeightForTargetAtIndex Lib SceneKitLib Selector "weightForTargetAtIndex:" (id as ptr, index as integer) As cgfloat
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setcalculationMode Lib SceneKitLib Selector "setCalculationMode:" (id as ptr, value as SCNMorpherCalculationMode)
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setTargets Lib SceneKitLib Selector "setTargets:" (id as ptr, targets as ptr)
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Sub setWeightForTargetAtIndex Lib SceneKitLib Selector "setWeight:forTarget:atIndex:" (id as ptr, index as integer, value as cgfloat)
	#tag EndExternalMethod
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNMorpher")
			  return mClassPtr
			End Get
		#tag EndGetter
