...
Inherits AppleScnObject
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub addBehavior Lib SceneKitLib Selector "addBehavior:" (id as ptr, behavior as ptr)
	...
	#tag Method, Flags = &h0, Description = 436865636B7320666F7220636F6E7461637473206265747765656E2074776F207068797369637320626F646965732E
		Function ContactTest(BodyA As AppleSCNPhysicsBody, BodyB As AppleSCNPhysicsBody, options as AppleSCNPhysicsWorldContactTestOptionsDictionary = nil) As AppleArray
		  return AppleArray.MakeFromPtr(contactTestBetweenBody(id, BodyA.id, bodyb.Id, if (options = nil,nil, options.id)))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0, Description = 436865636B7320666F7220636F6E7461637473206265747765656E206F6E65207068797369637320626F647920616E6420616E79206F7468657220626F6469657320696E20746865207068797369637320776F726C642E
		Function ContactTest(Body As AppleSCNPhysicsBody, options as AppleSCNPhysicsWorldContactTestOptionsDictionary = nil) As AppleArray
		  return AppleArray.MakeFromPtr(contactTestWithBody(id, Body.id,  if (options = nil,nil, options.id)))
		End Function
	#tag EndMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function contactTestBetweenBody Lib SceneKitLib Selector "contactTestBetweenBody:andBody:options:" (id as ptr, bodyA as ptr, bodyB as Ptr, options as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function contactTestWithBody Lib SceneKitLib Selector "contactTestWithBody:options:" (id as ptr, body as ptr, options as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function convexSweepTestWithShape Lib SceneKitLib Selector "convexSweepTestWithShape:fromTransform:toTransform:options:" (id as ptr, shape as ptr, fromTransform as SCNMatrix4, toTransform as SCNMatrix4, options as Ptr) As ptr
	#tag EndExternalMethod
	...
	#tag Method, Flags = &h0, Description = 536561726368657320666F72207068797369637320626F6469657320696E2074686520737061636520666F726D6564206279206D6F76696E67206120636F6E766578207368617065207468726F75676820746865207068797369637320776F726C642E
		Function ConvexTest(Shape As AppleSCNPhysicsShape, FromTRansform as SCNMatrix4, toTransform as SCNMatrix4, options as AppleSCNPhysicsWorldContactTestOptionsDictionary = nil) As AppleArray
		  return AppleArray.MakeFromPtr(convexSweepTestWithShape(id, shape.Id, FromTRansform, toTransform, if (options = nil,nil, options.id)))
		  
		End Function
	#tag EndMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getallBehaviors Lib SceneKitLib Selector "allBehaviors" (id as ptr) As Ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getcontactDelegate Lib SceneKitLib Selector "contactDelegate" (id as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getgravity Lib SceneKitLib Selector "gravity" (id as ptr) As SCNVector3
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getgravity32 Lib SceneKitLib Selector "gravity" (id as ptr) As SCNVector3_32Bit
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function gettimeStep Lib SceneKitLib Selector "timeStep" (id as ptr) As double
	#tag EndExternalMethod
	...
	#tag Method, Flags = &h0, Description = 536561726368657320666F72207068797369637320626F6469657320616C6F6E672061206C696E65207365676D656E74206265747765656E2074776F20706F696E747320696E20746865207068797369637320776F726C642E
		Function Raytest(Origin As SCNVector3, destination As SCNVector3, options as AppleSCNPhysicsWorldContactTestOptionsDictionary = nil) As AppleArray
		  #if Target64Bit
		    return AppleArray.MakeFromPtr(rayTestWithSegmentFromPoint(id, origin, destination, if (options = nil,nil, options.id)))
		  #elseif Target32Bit
		    return AppleArray.MakeFromPtr(rayTestWithSegmentFromPoint32(id, origin.toVector3_32, destination.toVector3_32, if (options = nil,nil, options.id)))
		  #endif
		End Function
	#tag EndMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function rayTestWithSegmentFromPoint Lib SceneKitLib Selector "rayTestWithSegmentFromPoint:toPoint:options:" (id as ptr, Origin as SCNVector3, Destination as SCNVector3, options as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function rayTestWithSegmentFromPoint32 Lib SceneKitLib Selector "rayTestWithSegmentFromPoint:toPoint:options:" (id as ptr, Origin as SCNVector3_32Bit, Destination as SCNVector3_32Bit, options as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub removeAllBehaviors Lib SceneKitLib Selector "removeAllBehaviors" (id as ptr)
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub removeBehavior Lib SceneKitLib Selector "removeBehavior:" (id as ptr, behavior as ptr)
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setcontactDelegate Lib SceneKitLib Selector "setContactDelegate:" (id as ptr, value as ptr)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setgravity Lib SceneKitLib Selector "setGravity:" (id as ptr, value as SCNVector3)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setgravity32 Lib SceneKitLib Selector "setGravity:" (id as ptr, value as SCNVector3_32Bit)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub settimeStep Lib SceneKitLib Selector "setTimeStep:" (id as ptr, value as double)
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub updateCollisionPairs Lib SceneKitLib Selector "updateCollisionPairs" (id as ptr)
	#tag EndExternalMethod
	...
	#tag ComputedProperty, Flags = &h0, Description = 546865206772617669746174696F6E616C20616363656C65726174696F6E206170706C69656420746F207068797369637320626F6469657320696E20746865207068797369637320776F726C642E
		#tag Getter
			Get
			  ...
			  #elseif Target32Bit
			    return getgravity32(id).toVector3
			  #endif
			End Get
		#tag EndGetter
		#tag Setter
			Set
			    ...
			    setgravity(id), value
			  #elseif Target32Bit
			    setgravity32(id, value.toVector3_32)
			  #endif
			End Set
		#tag EndSetter
