...
Inherits AppleSCNGeometry
	...
	#tag Method, Flags = &h1000, Description = 437265617465732061207370686572652067656F6D6574727920776974682074686520737065636966696564207261646975732E
		Sub Constructor(Radius As Double)
		  #if Target64Bit
		    Declare function sphereWithRadius lib SceneKitLib selector "sphereWithRadius:" (id as ptr, Radius as double) as ptr
		  #elseif Target32Bit
		    Declare function sphereWithRadius lib SceneKitLib selector "sphereWithRadius:" (id as ptr, Radius as single) as ptr
		  #endif
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNSphere")
			  return mClassPtr
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 57686574686572205363656E654B6974207573657320612067656F646573696320706F6C79676F6E206D65736820746F2072656E64657220746865207370686572652E
		#tag Getter
			Get
			  declare Function isGeodesic lib SceneKitLib selector "isGeodesic" (id as ptr) as Boolean
			  return isGeodesic (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare sub setGeodesic lib SceneKitLib selector "setGeodesic:" (id as ptr, value as Boolean)
