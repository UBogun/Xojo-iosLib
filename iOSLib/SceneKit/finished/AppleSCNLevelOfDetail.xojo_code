...
Inherits AppleObject
	...
	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getscreenSpaceRadius Lib SceneKitLib Selector "screenSpaceRadius" (id as ptr) As CGFloat
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getworldSpaceDistance Lib SceneKitLib Selector "worldSpaceDistance" (id as ptr) As CGFloat
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function levelOfDetailWithGeometryscreenSpaceRadius Lib SceneKitLib Selector "levelOfDetailWithGeometry:screenSpaceRadius:" (id as ptr, Geometry as Ptr, Radius as CGFloat) As Ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function levelOfDetailWithGeometryworldSpaceDistance Lib SceneKitLib Selector "levelOfDetailWithGeometry:worldSpaceDistance:" (id as ptr, Geometry as Ptr, Radius as CGFloat) As Ptr
	#tag EndExternalMethod
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNLevelOfDetail")
			  return mClassPtr
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 546865206D6178696D756D207261646975732028696E20706978656C7329206F66207468652067656F6D65747279E280997320626F756E64696E672073706865726520666F722074686973206C6576656C206F662064657461696C20746F206170706561722E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  return getscreenSpaceRadius(id)
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h0, Description = 546865206D696E696D756D2064697374616E63652066726F6D207468652063757272656E7420706F696E74206F66207669657720666F722074686973206C6576656C206F662064657461696C20746F206170706561722E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  return getworldSpaceDistance(id)
			End Get
		#tag EndGetter
