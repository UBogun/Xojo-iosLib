...
Inherits AppleObject
	...
	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getaudioNode Lib SceneKitLib Selector "audioNode" (id as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function getaudioSource Lib SceneKitLib Selector "audioSource" (id as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function initWithAVAudioNode Lib SceneKitLib Selector "initWithAVAudioNode:" (id as ptr, audioNode as ptr) As Ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Function initWithSource Lib SceneKitLib Selector "initWithSource:" (id as ptr, source as ptr) As Ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Sub setdidFinishPlayback Lib SceneKitLib Selector "setDidFinishPlayback:" (id as ptr, block as ptr)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit))
		Protected Declare Sub setwillStartPlayback Lib SceneKitLib Selector "setWillStartPlayback:" (id as ptr, block as ptr)
	#tag EndExternalMethod
	...
	#tag ComputedProperty, Flags = &h0, Description = 54686520617564696F206E6F6465205363656E654B6974207573657320666F72206D6978696E6720617564696F2066726F6D207468697320706C617965722E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  return AppleAVAudioNode.MakeFromPtr(getaudioNode(id))
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNAudioPlayer")
			  return mClassPtr
			End Get
		#tag EndGetter
