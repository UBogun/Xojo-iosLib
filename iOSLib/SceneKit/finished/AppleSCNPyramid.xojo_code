...
Inherits AppleSCNGeometry
	...
	#tag Method, Flags = &h1000, Description = 43726561746573206120707972616D69642067656F6D65747279207769746820746865207370656369666965642077696474682C206865696768742C20616E64206C656E6774682E
		Sub Constructor(Width As Double, Height As Double, Length As Double)
		  #if Target64Bit
		    Declare function pyramidWithWidth lib SceneKitLib selector "pyramidWithWidth:height:length:" (id as ptr, Width as double, Height as double, Length as Double) as ptr
		  #elseif Target32Bit
		    Declare function pyramidWithWidth lib SceneKitLib selector "pyramidWithWidth:height:length::" (id as ptr, Width as single, Height as single, Length as single) as ptr
		  #endif
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNPyramid")
			  return mClassPtr
			End Get
		#tag EndGetter
