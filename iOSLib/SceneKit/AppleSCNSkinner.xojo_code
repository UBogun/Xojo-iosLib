...
Inherits AppleObject
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getbaseGeometry Lib SceneKitLib Selector "baseGeometry" (id as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getbaseGeometryBindTransform Lib SceneKitLib Selector "baseGeometryBindTransform" (id as ptr) As SCNMatrix4
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getboneInverseBindTransforms Lib SceneKitLib Selector "boneInverseBindTransforms" (id as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getbones Lib SceneKitLib Selector "bones" (id as ptr) As ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function getskeleton Lib SceneKitLib Selector "skeleton" (id as ptr) As ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setbaseGeometry Lib SceneKitLib Selector "setBaseGeometry:" (id as ptr, value as ptr)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setbaseGeometryBindTransform Lib SceneKitLib Selector "setBaseGeometryBindTransform:" (id as ptr, value as SCNMatrix4)
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Sub setskeleton Lib SceneKitLib Selector "setSkeleton:" (id as ptr, value as ptr)
	#tag EndExternalMethod
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  static mClassPtr as Ptr = FoundationFramework.NSClassFromString ("SCNSkinner")
			  return mClassPtr
			End Get
		#tag EndGetter
