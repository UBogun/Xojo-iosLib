...
Inherits AppleCAAnimation
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function animations lib QuartzCore selector "animations" (id as ptr) as Ptr
		...
		#tag Setter
			Set
			  declare Sub setAnimations lib QuartzCore selector "setAnimations:" (id as ptr, value as Ptr)
