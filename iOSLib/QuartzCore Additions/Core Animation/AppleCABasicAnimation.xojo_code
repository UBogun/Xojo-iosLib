...
Inherits AppleCAPropertyAnimation
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  DEclare Function byValue lib QuartzCore selector "byValue" (id as ptr) as ptr
		...
		#tag Setter
			Set
			  DEclare Sub setByValue lib QuartzCore selector "setByValue:" (id as ptr, value as ptr)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  DEclare Function fromValue lib QuartzCore selector "fromValue" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  DEclare Function toValue lib QuartzCore selector "toValue" (id as ptr) as ptr
		...
		#tag Setter
			Set
			  DEclare Sub setToValue lib QuartzCore selector "setToValue:" (id as ptr, value as ptr)
