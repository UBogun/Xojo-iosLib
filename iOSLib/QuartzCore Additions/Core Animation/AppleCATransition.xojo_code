...
Inherits AppleCAAnimation
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function endProgress lib QuartzCore selector "endProgress" (id as ptr) as Single
			  Return endProgress (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  Declare Sub setEndProgress lib QuartzCore selector "setEndProgress:" (id as ptr, value as Single)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function startProgress lib QuartzCore selector "startProgress" (id as ptr) as Single
			  Return startProgress (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  Declare Sub setStartProgress lib QuartzCore selector "setStartProgress:" (id as ptr, value as Single)
