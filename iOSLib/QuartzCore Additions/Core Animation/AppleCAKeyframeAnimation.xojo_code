...
Inherits AppleCAPropertyAnimation
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function keyTimes lib QuartzCore selector "keyTimes" (id as ptr) as Ptr
		...
		#tag Setter
			Set
			  declare Sub setKeyTimes lib QuartzCore selector "setKeyTimes:" (id as ptr, value as Ptr)
	...
	#tag ComputedProperty, Flags = &h21
		#tag Getter
			Get
			  Declare Function calculationMode lib QuartzCore selector "calculationMode" (id as ptr) as CFStringRef
			  return calculationMode (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare sub setCalculationMode lib QuartzCore selector "setCalculationMode:" (id as ptr, value as CFStringRef)
	...
	#tag ComputedProperty, Flags = &h21
		#tag Getter
			Get
			  Declare Function rotationMode lib QuartzCore selector "rotationMode" (id as ptr) as CFStringRef
			  return rotationMode (id)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare sub setRotationMode lib QuartzCore selector "setRotationMode:" (id as ptr, value as CFStringRef)
			  Declare sub setRotationModePtr lib QuartzCore selector "setRotationMode:" (id as ptr, value as ptr)
			  if value.Empty then
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function path lib QuartzCore selector "path" (id as ptr) as Ptr
		...
		#tag Setter
			Set
			  declare Sub setPath lib QuartzCore selector "setPath:" (id as ptr, value as Ptr)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function timingFunctions lib QuartzCore selector "timingFunctions" (id as ptr) as Ptr
		...
		#tag Setter
			Set
			  declare Sub setTimingFunctions lib QuartzCore selector "setTimingFunctions:" (id as ptr, value as Ptr)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function values lib QuartzCore selector "values" (id as ptr) as Ptr
		...
		#tag Setter
			Set
			  declare Sub setValues lib QuartzCore selector "setValues:" (id as ptr, value as Ptr)
