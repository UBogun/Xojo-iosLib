...
Inherits AppleCFObject
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function CFBooleanGetValue Lib CoreFoundation (Allocator as Ptr) As Boolean
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  static truePtr as Ptr = SystemConstantPtr (kCFBooleanFalse, CoreFoundationPath)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  static truePtr as Ptr = SystemConstantPtr (kCFBooleanTrue, CoreFoundationPath)
			  return new AppleCFBoolean(trueptr)
			End Get
		#tag EndGetter
