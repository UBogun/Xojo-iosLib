...
Protected Module QuartzCoreFramework
	...
	#tag Method, Flags = &h0
		Function CATransform3DConcat(T1 As CATransform3D, T2 As CATransform3D) As CATransform3D
		  #if target32bit
		    Declare function CATransform3DConcat lib QuartzCoreLib (T1 As CATransform3D32Bit, T2 As CATransform3D32Bit) as CATransform3D32Bit
	...
	#tag Method, Flags = &h0
		Function CATransform3DEqualToTransform(t1 as CATransform3D, t2 as CATransform3D) As Boolean
		  #if Target32Bit
		    Declare function CATransform3DEqualToTransform lib QuartzCoreLib (t1 as CATransform3D32Bit, t2 as CATransform3D32Bit) as Boolean
	...
	#tag Method, Flags = &h0
		Function CATransform3DGetAffineTransform(T as CATransform3D) As CGAffineTransform
		  #if target32bit
		    Declare function CATransform3DGetAffineTransform lib QuartzCoreLib (T as CATransform3D32Bit) as CGAffineTransform32Bit
		    return CATransform3DGetAffineTransform(t.toCATransform3D32Bit).toCGAffineTransform
		  #elseif Target64Bit
		    Declare function CATransform3DGetAffineTransform lib QuartzCoreLib (T as CATransform3D) as CGAffineTransform
	...
	#tag Method, Flags = &h0
		Function CATransform3DInvert(T As CATransform3D) As CATransform3D
		  #if target32bit
		    Declare function CATransform3DInvert lib QuartzCoreLib (T As CATransform3D32Bit) as CATransform3D32Bit
	...
	#tag Method, Flags = &h0
		Function CATransform3DIsIdentity(t as CATransform3D) As Boolean
		  #if Target32Bit
		    Declare function CATransform3DIsIdentity lib QuartzCoreLib (t as CATransform3D32Bit) as Boolean
	...
	#tag Method, Flags = &h0
		Function CATransform3DMakeAffineTransform(T as CGAffineTransform) As CATransform3D
		  #if target32bit
		    Declare function CATransform3DMakeAffineTransform lib QuartzCoreLib (T as CGAffineTransform32Bit) as CATransform3D32Bit
		    return CATransform3DMakeAffineTransform(t.toCGAffineTransform32Bit).toCATransform3D
		  #elseif Target64Bit
		    Declare function CATransform3DMakeAffineTransform lib QuartzCoreLib (T as CGAffineTransform) as CATransform3D
	...
	#tag Method, Flags = &h0
		Function CATransform3DMakeRotation(angle as double, x as double, y as double, z as double) As CATransform3D
		  #if target32bit
		    Declare function CATransform3DMakeRotation lib QuartzCoreLib (angle as single, x as single, y as single, z as single) as CATransform3D32Bit
		    return CATransform3DMakeRotation(angle,x, y, z).toCATransform3D
		  #elseif Target64Bit
		    Declare function CATransform3DMakeRotation lib QuartzCoreLib (angle as double, x as double, y as double, z as double) as CATransform3D
	...
	#tag Method, Flags = &h0
		Function CATransform3DMakeScale(scaleX as double, scaleY as Double = 0, scaleZ as Double = 0) As CATransform3D
		  ...
		  #if target32bit
		    Declare function CATransform3DMakeScale lib QuartzCoreLib (scaleX as single, ScaleY as Single, scaleZ as Single) as CATransform3D32Bit
		    return CATransform3DMakeScale(ScaleX, ScaleY, scaleZ).toCATransform3D
		  #elseif Target64Bit
		    Declare function CATransform3DMakeScale lib QuartzCoreLib (scaleX as Double, ScaleY as Double, ScaleZ as Double) as CATransform3D
	...
	#tag Method, Flags = &h0
		Function CATransform3DMakeTranslation(tx as Double, ty as Double, tz as double) As CATransform3D
		  #if target32bit
		    Declare function CATransform3DMakeTranslation lib QuartzCoreLib ( tx as Single, ty as Single, tz as single) as CATransform3D32Bit
		    return CATransform3DMakeTranslation(tx, ty, tz).tocaTransForm3D
		  #elseif Target64Bit
		    Declare function CATransform3DMakeTranslation lib QuartzCoreLib ( tx as Double, ty as Double, tz as double) as CATransform3D
	...
	#tag Method, Flags = &h0
		Function CATransform3DRotate(T As CATransform3D, angle as double, x as double, y as double, z as double) As CATransform3D
		  #if target32bit
		    Declare function CATransform3DRotate lib QuartzCoreLib (T As CATransform3D32Bit, angle as single, x as Single, y as single, z as single) as CATransform3D32Bit
		    return CATransform3DRotate(T.toCATransform3D32Bit, angle, x, y, z).toCATransform3D
		  #elseif Target64Bit
		    Declare function CATransform3DRotate lib QuartzCoreLib (T As CGAffineTransform, angle as double, x as double, y as double, z as double) as CATransform3D
	...
	#tag Method, Flags = &h0
		Function CATransform3DScale(T as CATransform3D, scaleX as double, scaleY as Double = 0, ScaleZ As Double) As CATransform3D
		  ...
		  #if target32bit
		    Declare function CATransform3DScale lib QuartzCoreLib (T as CATransform3D32Bit, scaleX as single, ScaleY as Single, ScaleZ As Single) as CATransform3D32Bit
		    return CATransform3DScale (t.toCATransform3D32Bit, ScaleX, ScaleY, ScaleZ).tocatransform3d
		  #elseif Target64Bit
		    Declare function CATransform3DScale lib QuartzCoreLib (T as CGAffineTransform, scaleX as Double, ScaleY as Double, ScaleZ as Double) as CATransform3D
	...
	#tag Method, Flags = &h0
		Function CATransform3DTranslate(T as CATransform3D, DeltaX as double, DeltaY as Double, DeltaZ as Double) As CATransform3D
		  #if target32bit
		    Declare function CATransform3DTranslate lib QuartzCoreLib (T as CATransform3D32Bit, DeltaX as single, DeltaY as Single, DeltaZ as single) as CATransform3D32Bit
		    return CATransform3DTranslate(t.toCATransform3D32Bit, DeltaX, DeltaY, deltaz).toCATransform3D
		  #elseif Target64Bit
		    Declare function CATransform3DTranslate lib QuartzCoreLib (T as CATransform3D, DeltaX as Double, DeltaY as Double, DeltaZ as double) as CATransform3D
