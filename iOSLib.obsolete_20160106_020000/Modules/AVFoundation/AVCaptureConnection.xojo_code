...
Inherits NSObject
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function videoMaxFrameDuration_ lib AVFoundationLib selector "videoMaxFrameDuration" (obj_id as ptr) as AVFoundation.CMTime
			  Return (videoMaxFrameDuration_(self))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare sub videoMaxFrameDuration_ lib AVFoundationLib selector "setVideoMaxFrameDuration:" (obj_id as ptr, videoMaxFrameDuration as AVFoundation.CMTime)
			  videoMaxFrameDuration_(self, value)
			End Set
		#tag EndSetter
		videoMaxFrameDuration As AVFoundation.CMTime
	#tag EndComputedProperty

	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function videoMinFrameDuration_ lib AVFoundationLib selector "videoMinFrameDuration" (obj_id as ptr) as AVFoundation.CMTime
			  Return (videoMinFrameDuration_(self))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare sub videoMinFrameDuration_ lib AVFoundationLib selector "setVideoMinFrameDuration:" (obj_id as ptr, videoMinFrameDuration as AVFoundation.CMTime)
			  videoMinFrameDuration_(self, value)
			End Set
		#tag EndSetter
		videoMinFrameDuration As AVFoundation.CMTime
	#tag EndComputedProperty
