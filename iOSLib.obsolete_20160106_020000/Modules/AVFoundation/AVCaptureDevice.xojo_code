...
Inherits NSObject
	...
	#tag Method, Flags = &h0
		Sub SetExposureModeCustomWithDurationISOCompletionHandler(duration as AVFoundation.CMTime, ISO as double, handler as iOSBlock)
		  declare sub setExposureModeCustomWithDuration_ lib AVFoundationLib selector "setExposureModeCustomWithDuration:ISO:completionHandler:" (obj_id as ptr, duration as AVFoundation.CMTime, ISO as Double, handler as ptr)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function activeVideoMaxFrameDuration_ lib AVFoundationLib selector "activeVideoMaxFrameDuration" (obj_id as ptr) as AVFoundation.CMTime
			  Return (activeVideoMaxFrameDuration_(self))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare sub activeVideoMaxFrameDuration_ lib AVFoundationLib selector "setActiveVideoMaxFrameDuration:" (obj_id as ptr, activeVideoMaxFrameDuration as AVFoundation.CMTime)
			  activeVideoMaxFrameDuration_(self, value)
			End Set
		#tag EndSetter
		activeVideoMaxFrameDuration As AVFoundation.CMTime
	#tag EndComputedProperty

	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function activeVideoMinFrameDuration_ lib AVFoundationLib selector "activeVideoMinFrameDuration" (obj_id as ptr) as AVFoundation.CMTime
			  Return (activeVideoMinFrameDuration_(self))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare sub activeVideoMinFrameDuration_ lib AVFoundationLib selector "setActiveVideoMinFrameDuration:" (obj_id as ptr, activeVideoMinFrameDuration as AVFoundation.CMTime)
			  activeVideoMinFrameDuration_(self, value)
			End Set
		#tag EndSetter
		activeVideoMinFrameDuration As AVFoundation.CMTime
	#tag EndComputedProperty
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function exposureDuration_ lib AVFoundationLib selector "exposureDuration" (obj_id as ptr) as AVFoundation.CMTime
			  Return (exposureDuration_(self))
			End Get
		#tag EndGetter
		exposureDuration As AVFoundation.CMTime
	#tag EndComputedProperty
