...
Inherits AVFoundation.AVCaptureOutput
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function maxRecordedDuration_ lib AVFoundationLib selector "maxRecordedDuration" (obj_id as ptr) as AVFoundation.CMTime
			  Return (maxRecordedDuration_(self))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare sub maxRecordedDuration_ lib AVFoundationLib selector "setMaxRecordedDuration:" (obj_id as ptr, maxRecordedDuration as AVFoundation.CMTime)
			  maxRecordedDuration_(self, value)
			End Set
		#tag EndSetter
		maxRecordedDuration As AVFoundation.CMTime
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function recordedDuration_ lib AVFoundationLib selector "recordedDuration" (obj_id as ptr) as AVFoundation.CMTime
			  Return (recordedDuration_(self))
			End Get
		#tag EndGetter
		recordedDuration As AVFoundation.CMTime
	#tag EndComputedProperty
