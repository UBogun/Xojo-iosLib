...
Inherits NSObject
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function duration_ lib AVFoundationLib selector "duration" (obj_id as ptr) as AVFoundation.CMTime
			  Return (duration_(self))
			End Get
		#tag EndGetter
		duration As AVFoundation.CMTime
	#tag EndComputedProperty

	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function time_ lib AVFoundationLib selector "time" (obj_id as ptr) as AVFoundation.CMTime
			  Return time_(self)
			End Get
		#tag EndGetter
		time As AVFoundation.CMTime
	#tag EndComputedProperty
