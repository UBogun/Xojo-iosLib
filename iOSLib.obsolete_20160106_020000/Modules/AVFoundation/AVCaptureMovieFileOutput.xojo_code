...
Inherits AVFoundation.AVCaptureFileOutput
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function movieFragmentInterval_ lib AVFoundationLib selector "movieFragmentInterval" (obj_id as ptr) as AVFoundation.CMTime
			  Return (movieFragmentInterval_(self))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  declare sub movieFragmentInterval_ lib AVFoundationLib selector "setMovieFragmentInterval:" (obj_id as ptr, movieFragmentInterval as AVFoundation.CMTime)
			  movieFragmentInterval_(self, value)
			End Set
		#tag EndSetter
		movieFragmentInterval As AVFoundation.CMTime
	#tag EndComputedProperty
