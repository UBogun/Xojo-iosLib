...
Inherits NSObject
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function maxExposureDuration_ lib AVFoundationLib selector "maxExposureDuration" (obj_id as ptr) as AVFoundation.CMTime
			  Return (maxExposureDuration_(self))
			End Get
		#tag EndGetter
		maxExposureDuration As AVFoundation.CMTime
	#tag EndComputedProperty
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  declare function minExposureDuration_ lib AVFoundationLib selector "minExposureDuration" (obj_id as ptr) as AVFoundation.CMTime
			  Return (minExposureDuration_(self))
			End Get
		#tag EndGetter
		minExposureDuration As AVFoundation.CMTime
	#tag EndComputedProperty
