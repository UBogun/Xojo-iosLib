#tag Class
Protected Class iOSControlsBlurExtraLightEffectView
Inherits iOSControlsBlurEffectView
	#tag Event
		Function CreateView() As UInteger
		  BlurEffect = new UIBlurEffect (UIVisualEffectView.BlurEffectStyle.ExtraLight)
