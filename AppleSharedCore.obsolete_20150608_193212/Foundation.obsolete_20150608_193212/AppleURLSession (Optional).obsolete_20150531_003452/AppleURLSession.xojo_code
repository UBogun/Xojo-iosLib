#tag Class
Protected Class AppleURLSession1
Inherits AppleObject
	#tag Method, Flags = &h0
		Function AddDataTask(URL as AppleURL) As AppleURLSessionTask
		  Declare Function dataTaskWithURL lib Foundation selector "dataTaskWithURL:" (id as ptr, url as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function AddDataTask(URL as AppleURL, completionHandler as ptr) As AppleURLSessionTask
		  Declare Function dataTaskWithURLCompletion lib Foundation selector "dataTaskWithURL:completionHandler:" (id as ptr, url as ptr, completionHandler as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function AddDataTask(Request as AppleURLRequest) As AppleURLSessionTask
		  Declare Function dataTaskWithRequest lib Foundation selector "dataTaskWithRequest:" (id as ptr, request as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function AddDataTask(Request as AppleURLRequest, completionHandler as ptr) As AppleURLSessionTask
		  Declare Function dataTaskWithRequestCompletion lib Foundation selector "dataTaskWithRequest:completionHandler:" (id as ptr, request as ptr, completionHandler as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function AddDownloadTask(ResumeData as Appledata) As AppleURLSessionDownloadTask
		  Declare Function downloadTaskWithResumeData lib Foundation selector "downloadTaskWithResumeData:" (id as ptr, url as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function AddDownloadTask(ResumeData as Appledata, completionHandler as ptr) As AppleURLSessionDownloadTask
		  Declare Function downloadTaskWithResumeDataCompletion lib Foundation selector "downloadTaskWithResumeData:completionHandler:" (id as ptr, url as ptr, completionHandler as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function AddDownloadTask(URL as AppleURL) As AppleURLSessionDownloadTask
		  Declare Function downloadTaskWithURL lib Foundation selector "downloadTaskWithURL:" (id as ptr, url as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function AddDownloadTask(URL as AppleURL, completionHandler as ptr) As AppleURLSessionDownloadTask
		  Declare Function downloadTaskWithURLCompletion lib Foundation selector "downloadTaskWithURL:completionHandler:" (id as ptr, url as ptr, completionHandler as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function AddDownloadTask(Request as AppleURLRequest) As AppleURLSessionDownloadTask
		  Declare Function downloadTaskWithRequest lib Foundation selector "downloadTaskWithRequest:" (id as ptr, url as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function AddDownloadTask(Request as AppleURLRequest, completionHandler as ptr) As AppleURLSessionDownloadTask
		  Declare Function downloadTaskWithRequestCompletion lib Foundation selector "downloadTaskWithRequest:completionHandler:" (id as ptr, url as ptr, completionHandler as ptr) as ptr
	...
	#tag Method, Flags = &h0
		Function AddUploadTask(Request as AppleURLRequest) As AppleURLSessionTask
		  Declare Function uploadTaskWithStreamedRequest lib Foundation selector "uploadTaskWithStreamedRequest:" _
	...
	#tag Method, Flags = &h0
		Function AddUploadTask(Request as AppleURLRequest, data as AppleData) As AppleURLSessionTask
		  Declare Function uploadTaskWithRequest lib Foundation selector "uploadTaskWithRequest:fromData:" _
	...
	#tag Method, Flags = &h0
		Function AddUploadTask(Request as AppleURLRequest, data as AppleData, completionHandler as ptr) As AppleURLSessionTask
		  Declare Function uploadTaskWithRequestCompletion lib Foundation selector "uploadTaskWithRequest:fromData:completionHandler:" _
	...
	#tag Method, Flags = &h0
		Function AddUploadTask(Request as AppleURLRequest, file as AppleURL) As AppleURLSessionTask
		  Declare Function uploadTaskWithRequestFile lib Foundation selector "uploadTaskWithRequest:fromFile:" _
	...
	#tag Method, Flags = &h0
		Function AddUploadTask(Request as AppleURLRequest, file as AppleURL, completionHandler as ptr) As AppleURLSessionTask
		  Declare Function uploadTaskWithRequestFileCompletion lib Foundation selector "uploadTaskWithRequest:fromFile:completionHandler:" _
	...
	#tag Method, Flags = &h1000
		Sub constructor()
		  Declare Function sharedSession lib Foundation selector "sharedSession" (id as ptr) as ptr
	...
	#tag Method, Flags = &h1000
		Sub constructor(Configuration as AppleURLSessionConfiguration)
		  Declare Function sessionWithConfiguration lib Foundation selector "sessionWithConfiguration:" (id as ptr, configuration as ptr) as ptr
	...
	#tag Method, Flags = &h1000
		Sub constructor(Configuration as AppleURLSessionConfiguration, Sessiondelegate as AppleURLSessionDelegate, delegatequeue as AppleOperationQueue)
		  Declare Function sessionWithConfigurationDelegate lib Foundation selector "sessionWithConfiguration:delegate:delegateQueue:" _
	...
	#tag Method, Flags = &h0
		Sub FinishTasksAndInvalidate()
		  Declare sub finishTasksAndInvalidate lib Foundation selector "finishTasksAndInvalidate" (id as ptr)
	...
	#tag Method, Flags = &h0
		Sub Flush()
		  Declare sub flushWithCompletionHandler lib Foundation selector "flushWithCompletionHandler:" (id as ptr, completionHandler as ptr)
	...
	#tag Method, Flags = &h0
		Sub GetTasks()
		  Declare sub getTasksWithCompletionHandler lib Foundation selector "getTasksWithCompletionHandler:" (id as ptr, completionHandler as ptr)
	...
	#tag Method, Flags = &h0
		Sub InvalidateAndCancel()
		  Declare sub invalidateAndCancel lib Foundation selector "invalidateAndCancel" (id as ptr)
	...
	#tag Method, Flags = &h0
		Sub Reset()
		  Declare sub resetWithCompletionHandler lib Foundation selector "resetWithCompletionHandler:" (id as ptr, completionHandler as ptr)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function configuration lib Foundation selector "configuration" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function delegateQueue lib Foundation selector "delegateQueue" (id as ptr) as ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function delegate_ lib Foundation selector "delegate" (id as ptr) as Ptr
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Declare Function sessionDescription lib Foundation selector "sessionDescription" (id as ptr) as CFStringRef
