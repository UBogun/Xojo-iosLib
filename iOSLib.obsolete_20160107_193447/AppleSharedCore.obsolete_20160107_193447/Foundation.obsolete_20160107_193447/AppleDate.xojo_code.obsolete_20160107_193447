...
Inherits AppleObject
	...
	#tag Method, Flags = &h0
		Function Compare(AnotherDate as AppleDate) As FoundationFramework.NSComparisonResult
		  return compare (id, AnotherDate.id)
		End Function
	#tag EndMethod

	#tag ExternalMethod, Flags = &h1
		Attributes( hidden ) Protected Declare Function compare Lib FoundationLibName Selector "compare:" (id as ptr, otherDate as ptr) As FoundationFramework.NSComparisonResult
