...
Inherits AppleCAMediaTimingObject
	...
	#tag Method, Flags = &h0
		Sub RenderInContext(context as AppleCGContext)
		  declare Sub renderInContext lib QuartzCoreLib selector "renderInContext:" (id as ptr, context as ptr)
		  renderInContext id, context.CFTypeRef
		End Sub
	#tag EndMethod
